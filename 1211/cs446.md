...
# Week 1: Course Overview and Learning Outcomes

CS 446 / ECE 452 / CS 646 is a course on **software design and architecture** taught by Shane McIntosh at the University of Waterloo (Winter 2021). The course is delivered asynchronously — there are no scheduled lectures or tutorials. Slide decks with detailed annotations are released on Mondays and Wednesdays by 10 AM EST, and serve as the primary learning resource.

The course follows a **project-based learning** model. The main deliverables are a group mobile application and the architectural and design documents that accompany it, culminating in an oral exam in which each team presents and defends their architectural choices.

## Intended Learning Outcomes

By the end of the course, students should be able to:

- **Differentiate** how various architectural styles and design patterns enhance or degrade a system's functional and non-functional properties. In large software systems comprising millions of lines of code, architectural decisions can have an even larger impact on system quality than individual coding practices.
- **Generate and justify** an architecture and/or design given a collection of requirements — navigating operational constraints to propose structures that achieve high-level goals.
- **Produce and present** concise, unambiguous architecture and design descriptions that communicate solutions to both technical stakeholders (developers, QA) and non-technical ones (product managers, marketing).
- **Create and implement** an architecture and design, iteratively refining it into a complete working system.
...
| Project | 30% |
| Quizzes (10 × 3%) | 30% |
| Architecture and Design Examples | 20% |
| Oral Exam | 20% |

The project grade is computed as `(base score + bonus) × scaling factor`, where the scaling factor (0.0–1.0) reflects completeness, utility, polish, difficulty, pivot response, and individual effort (assessed via peer evaluation and activity logs).

---

# Week 2: Stakeholders and Non-Functional Properties
...
# Week 3: Introduction to Software Architecture
...
# Week 4: Why Software Architecture Is Difficult
...
# Week 5: Software Architecture Styles — Introduction
...
# Week 6: Architectural Views and Decomposition
...
# Week 7: UML for Software Architecture
...
# Week 8: Object-Oriented Design Patterns — Introduction
...
# Week 10: Architectural Styles — Pipe-and-Filter, Data-Centred
...
# Week 11: Architectural Styles — Implicit Invocation, Layered, Client–Server, Process-Control
...
# Week 13: Software Cost Estimation
