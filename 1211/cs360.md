...
1. <span>&#92;(w = \epsilon &#92;)</span> and <span>&#92;(q _ 0\in F &#92;)</span>.
...
function having the form <span>&#92;(\delta: Q\times (\Sigma \cup &#92;left&#92;{ \epsilon &#92;right&#92;}) \to \mathcal P(Q) &#92;)</span>, q<sub>0</sub> start state, F is a subset of accept states.
...
Also note we allow <span>&#92;(\epsilon &#92;)</span>-transitions, where an NFA may move from one state to another without
...
First we define <span>&#92;(\epsilon &#92;)</span>-closure of any set <span>&#92;(R\subseteq R &#92;)</span> as <span>&#92;(\epsilon (R) &#92;)</span> = {q ∈ Q : q is reachable from some r ∈ R by following
zero or more ε-transitions }. We can interpret this alternative definition as saying that <span>&#92;(\epsilon (R) &#92;)</span> is the smallest subset
