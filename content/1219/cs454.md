...
These notes draw on Tanenbaum & Van Steen's *Distributed Systems: Principles and Paradigms* and Coulouris, Dollimore & Kindberg's *Distributed Systems: Concepts and Design*. Enriching context and real-world examples have been added throughout.
...
<svg viewBox="0 0 540 210" xmlns="http://www.w3.org/2000/svg" style="max-width:540px;display:block;margin:1.5em auto">
  <defs>
    <marker id="arrcs" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="currentColor"/>
    </marker>
    <marker id="arrcsl" markerWidth="8" markerHeight="8" refX="2" refY="3" orient="auto">
      <path d="M8,0 L8,6 L0,3 z" fill="currentColor"/>
    </marker>
  </defs>
  <!-- Client-Server side -->
  <text x="130" y="16" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">Client-Server</text>
  <rect x="10" y="30" width="80" height="35" rx="5" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="50" y="52" text-anchor="middle" font-size="11" fill="#3b82f6">Client 1</text>
  <rect x="10" y="80" width="80" height="35" rx="5" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="50" y="102" text-anchor="middle" font-size="11" fill="#3b82f6">Client 2</text>
  <rect x="10" y="130" width="80" height="35" rx="5" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="50" y="152" text-anchor="middle" font-size="11" fill="#3b82f6">Client 3</text>
  <rect x="165" y="80" width="90" height="35" rx="5" fill="none" stroke="#ef4444" stroke-width="2.5"/>
  <text x="210" y="102" text-anchor="middle" font-size="12" font-weight="bold" fill="#ef4444">Server</text>
  <path d="M90,47 L165,90" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)"/>
  <path d="M90,97 L165,97" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)"/>
  <path d="M90,147 L165,105" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)"/>
  <text x="130" y="68" text-anchor="middle" font-size="9" fill="currentColor">requests →</text>
  <!-- P2P side -->
  <text x="410" y="16" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">Peer-to-Peer</text>
  <rect x="290" y="30" width="75" height="35" rx="5" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="327" y="52" text-anchor="middle" font-size="11" fill="#22c55e">Peer A</text>
  <rect x="455" y="30" width="75" height="35" rx="5" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="492" y="52" text-anchor="middle" font-size="11" fill="#22c55e">Peer B</text>
  <rect x="290" y="140" width="75" height="35" rx="5" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="327" y="162" text-anchor="middle" font-size="11" fill="#22c55e">Peer C</text>
  <rect x="455" y="140" width="75" height="35" rx="5" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="492" y="162" text-anchor="middle" font-size="11" fill="#22c55e">Peer D</text>
  <!-- P2P connections (bidirectional) -->
  <path d="M365,47 L455,47" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)" marker-start="url(#arrcsl)"/>
  <path d="M327,65 L327,140" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)" marker-start="url(#arrcsl)"/>
  <path d="M492,65 L492,140" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)" marker-start="url(#arrcsl)"/>
  <path d="M365,157 L455,157" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arrcs)" marker-start="url(#arrcsl)"/>
  <path d="M360,65 L460,140" fill="none" stroke="currentColor" stroke-width="1" stroke-dasharray="3,2"/>
  <text x="410" y="195" text-anchor="middle" font-size="9" fill="currentColor">every node is client and server</text>
</svg>
...
<svg viewBox="0 0 480 280" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;display:block;margin:1.5em auto">
  <defs>
    <marker id="arrlc" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="currentColor"/>
    </marker>
  </defs>
  <text x="240" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Lamport Logical Clocks</text>
  <!-- Process lines -->
  <text x="60" y="40" text-anchor="middle" font-size="11" font-weight="bold" fill="#3b82f6">P₁</text>
  <line x1="60" y1="50" x2="60" y2="260" stroke="#3b82f6" stroke-width="2"/>
  <text x="240" y="40" text-anchor="middle" font-size="11" font-weight="bold" fill="#ef4444">P₂</text>
  <line x1="240" y1="50" x2="240" y2="260" stroke="#ef4444" stroke-width="2"/>
  <text x="420" y="40" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">P₃</text>
  <line x1="420" y1="50" x2="420" y2="260" stroke="#22c55e" stroke-width="2"/>
  <!-- Events P1 -->
  <circle cx="60" cy="80" r="10" fill="#3b82f6"/>
  <text x="60" y="84" text-anchor="middle" font-size="9" fill="white">1</text>
  <text x="38" y="84" font-size="9" fill="currentColor">a:1</text>
  <circle cx="60" cy="140" r="10" fill="#3b82f6"/>
  <text x="60" y="144" text-anchor="middle" font-size="9" fill="white">2</text>
  <text x="38" y="144" font-size="9" fill="currentColor">b:2</text>
  <circle cx="60" cy="220" r="10" fill="#3b82f6"/>
  <text x="60" y="224" text-anchor="middle" font-size="9" fill="white">4</text>
  <text x="38" y="224" font-size="9" fill="currentColor">d:4</text>
  <!-- Events P2 -->
  <circle cx="240" cy="100" r="10" fill="#ef4444"/>
  <text x="240" y="104" text-anchor="middle" font-size="9" fill="white">1</text>
  <text x="255" y="104" font-size="9" fill="currentColor">e:1</text>
  <circle cx="240" cy="160" r="10" fill="#ef4444"/>
  <text x="240" y="164" text-anchor="middle" font-size="9" fill="white">3</text>
  <text x="255" y="164" font-size="9" fill="currentColor">f:3</text>
  <!-- Events P3 -->
  <circle cx="420" cy="120" r="10" fill="#22c55e"/>
  <text x="420" y="124" text-anchor="middle" font-size="9" fill="white">1</text>
  <text x="435" y="124" font-size="9" fill="currentColor">g:1</text>
  <circle cx="420" cy="200" r="10" fill="#22c55e"/>
  <text x="420" y="204" text-anchor="middle" font-size="9" fill="white">4</text>
  <text x="435" y="204" font-size="9" fill="currentColor">h:4</text>
  <!-- Message b→f: P1→P2 -->
  <path d="M70,140 L230,158" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="5,2" marker-end="url(#arrlc)"/>
  <text x="155" y="142" text-anchor="middle" font-size="9" fill="currentColor">send ts=2</text>
  <!-- Message e→h: P2→P3 -->
  <path d="M250,100 L410,198" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="5,2" marker-end="url(#arrlc)"/>
  <text x="340" y="140" text-anchor="middle" font-size="9" fill="currentColor">send ts=1 → recv max(1,1)+1=2?→4</text>
  <!-- Note -->
  <text x="240" y="268" text-anchor="middle" font-size="9" fill="currentColor">C(event): clock value.  If a→b then C(a) &lt; C(b)</text>
</svg>
...
The **two-phase commit protocol** ensures atomic distributed transactions. A **coordinator** manages the commit/abort decision across all **participant** nodes.

<svg viewBox="0 0 500 300" xmlns="http://www.w3.org/2000/svg" style="max-width:500px;display:block;margin:1.5em auto">
  <defs>
    <marker id="arr2pc" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="currentColor"/>
    </marker>
    <marker id="arr2pcl" markerWidth="8" markerHeight="8" refX="2" refY="3" orient="auto">
      <path d="M8,0 L8,6 L0,3 z" fill="currentColor"/>
    </marker>
  </defs>
  <text x="250" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Two-Phase Commit Protocol</text>
  <!-- Coordinator -->
  <text x="90" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#3b82f6">Coordinator</text>
  <line x1="90" y1="45" x2="90" y2="280" stroke="#3b82f6" stroke-width="2" stroke-dasharray="5,3"/>
  <!-- Participant 1 -->
  <text x="280" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#ef4444">Participant 1</text>
  <line x1="280" y1="45" x2="280" y2="280" stroke="#ef4444" stroke-width="2" stroke-dasharray="5,3"/>
  <!-- Participant 2 -->
  <text x="430" y="38" text-anchor="middle" font-size="11" font-weight="bold" fill="#ef4444">Participant 2</text>
  <line x1="430" y1="45" x2="430" y2="280" stroke="#ef4444" stroke-width="2" stroke-dasharray="5,3"/>
  <!-- Phase 1: PREPARE -->
  <rect x="10" y="55" width="480" height="18" rx="2" fill="#3b82f6" fill-opacity="0.1"/>
  <text x="250" y="68" text-anchor="middle" font-size="10" font-weight="bold" fill="#3b82f6">Phase 1: Prepare</text>
  <path d="M90,80 L280,80" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arr2pc)"/>
  <path d="M90,80 L430,90" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arr2pc)"/>
  <text x="180" y="76" text-anchor="middle" font-size="9" fill="currentColor">PREPARE</text>
  <path d="M280,110 L90,120" fill="none" stroke="#22c55e" stroke-width="1.5" marker-end="url(#arr2pcl)"/>
  <path d="M430,120 L90,125" fill="none" stroke="#22c55e" stroke-width="1.5" marker-end="url(#arr2pcl)"/>
  <text x="185" y="106" text-anchor="middle" font-size="9" fill="#22c55e">VOTE: YES/NO</text>
  <!-- Phase 2: COMMIT or ABORT -->
  <rect x="10" y="140" width="480" height="18" rx="2" fill="#22c55e" fill-opacity="0.1"/>
  <text x="250" y="153" text-anchor="middle" font-size="10" font-weight="bold" fill="#22c55e">Phase 2: Commit (if all YES) / Abort (if any NO)</text>
  <path d="M90,165 L280,165" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arr2pc)"/>
  <path d="M90,165 L430,175" fill="none" stroke="currentColor" stroke-width="1.5" marker-end="url(#arr2pc)"/>
  <text x="180" y="160" text-anchor="middle" font-size="9" fill="currentColor">COMMIT / ABORT</text>
  <path d="M280,195 L90,205" fill="none" stroke="#22c55e" stroke-width="1.5" marker-end="url(#arr2pcl)"/>
  <path d="M430,200 L90,210" fill="none" stroke="#22c55e" stroke-width="1.5" marker-end="url(#arr2pcl)"/>
  <text x="185" y="193" text-anchor="middle" font-size="9" fill="#22c55e">ACK</text>
  <!-- Notes -->
  <text x="250" y="250" text-anchor="middle" font-size="9" fill="currentColor">If coordinator crashes after PREPARE: participants block (uncertain state)</text>
  <text x="250" y="266" text-anchor="middle" font-size="9" fill="currentColor">Three-Phase Commit (3PC) adds pre-commit phase to avoid blocking</text>
</svg>
...
**CAP Theorem** (Brewer, 2000): A distributed system cannot simultaneously guarantee all three of Consistency, Availability, and Partition tolerance. When a network partition occurs, the system must choose between consistency and availability.

<svg viewBox="0 0 320 290" xmlns="http://www.w3.org/2000/svg" style="max-width:320px;display:block;margin:1.5em auto">
  <text x="160" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">CAP Theorem</text>
  <polygon points="160,35 35,250 285,250" fill="none" stroke="currentColor" stroke-width="2.5"/>
  <circle cx="160" cy="35" r="38" fill="#3b82f6" fill-opacity="0.15" stroke="#3b82f6" stroke-width="2"/>
  <text x="160" y="30" text-anchor="middle" font-size="12" font-weight="bold" fill="#3b82f6">Consistency</text>
  <text x="160" y="46" text-anchor="middle" font-size="9" fill="currentColor">all nodes see</text>
  <text x="160" y="58" text-anchor="middle" font-size="9" fill="currentColor">same data</text>
  <circle cx="35" cy="250" r="38" fill="#ef4444" fill-opacity="0.15" stroke="#ef4444" stroke-width="2"/>
  <text x="35" y="248" text-anchor="middle" font-size="12" font-weight="bold" fill="#ef4444">Availability</text>
  <text x="35" y="263" text-anchor="middle" font-size="9" fill="currentColor">every request</text>
  <text x="35" y="275" text-anchor="middle" font-size="9" fill="currentColor">gets response</text>
  <circle cx="285" cy="250" r="38" fill="#22c55e" fill-opacity="0.15" stroke="#22c55e" stroke-width="2"/>
  <text x="285" y="245" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">Partition</text>
  <text x="285" y="259" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">Tolerance</text>
  <text x="285" y="274" text-anchor="middle" font-size="9" fill="currentColor">survives splits</text>
  <text x="160" y="178" text-anchor="middle" font-size="11" fill="currentColor">Pick 2 of 3</text>
  <text x="160" y="196" text-anchor="middle" font-size="9" fill="currentColor">CA (no partition): traditional RDBMS</text>
  <text x="160" y="210" text-anchor="middle" font-size="9" fill="currentColor">CP (sacrifice avail): HBase, Zookeeper</text>
  <text x="160" y="224" text-anchor="middle" font-size="9" fill="currentColor">AP (eventual): Cassandra, DynamoDB</text>
</svg>
