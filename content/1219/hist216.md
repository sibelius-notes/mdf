---
title: "HIST 216: History of Information"
prof: "Course Author(s)"
subjects: "HIST"
---
...
1. The default condition of a book is to disappear. Most books exist once or twice, and then disappear.

2. There are no such things as editions (think of a microeconomics textbook in its seventeenth to eighteenth printing, for example). Instead, every book is its own edition.

3. You can’t really trust tables, diagrams, numbers, etc. because there is always a chance an error crept in.

4. If you want to amass knowledge, you have to physically travel: library A, library B, library C, spread across multiple towns, cities, or even countries.

5. Text is difficult to copy, but images, charts, diagrams, etc. are copied by hand as well, so there is even less standardization.
