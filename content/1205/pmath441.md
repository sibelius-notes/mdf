...
\[\operatorname{Gal}(F/K) \cong \operatorname{Gal}(L/K) / \operatorname{Gal}(L/F).\]</li>
</ol>
...
\[\operatorname{Tr}_{K/\mathbb{Q}}(\alpha) = \sum_{i=1}^{n} \sigma_i(\alpha), \qquad N_{K/\mathbb{Q}}(\alpha) = \prod_{i=1}^{n} \sigma_i(\alpha).\]</div>
...
\[f_\alpha(x) = p(x)^m = \prod_{\sigma \in \operatorname{Hom}_{\mathbb{Q}}(K, \mathbb{C})} \bigl(x - \sigma(\alpha)\bigr).\]</div>
...
\[\operatorname{Tr}_{L/\mathbb{Q}}(\alpha) = \operatorname{Tr}_{K/\mathbb{Q}}\bigl(\operatorname{Tr}_{L/K}(\alpha)\bigr), \qquad N_{L/\mathbb{Q}}(\alpha) = N_{K/\mathbb{Q}}\bigl(N_{L/K}(\alpha)\bigr).\]</div>
...
\[\operatorname{disc}(v_1, \ldots, v_n) = (\det C)^2 \cdot \operatorname{disc}(u_1, \ldots, u_n).\]</div>
...
\[\operatorname{disc}(1, \theta, \ldots, \theta^{n-1}) = \prod_{1 \le i < j \le n} (\theta_i - \theta_j)^2 = (-1)^{n(n-1)/2} N_{K/\mathbb{Q}}\bigl(p'(\theta)\bigr).\]</div>
...
\[\operatorname{disc}(x^2 + bx + c) = b^2 - 4c, \qquad \operatorname{disc}(x^3 + px + q) = -4p^3 - 27q^2.\]</div>
...
\[\operatorname{disc}(K) = \begin{cases} 4d & \text{if } d \not\equiv 1 \pmod{4}, \\ d & \text{if } d \equiv 1 \pmod{4}. \end{cases}\]</div>
...
\[\alpha = \frac{m_1 \alpha_1 + \cdots + m_n \alpha_n}{d}, \qquad d \mid m_i^2 \text{ for each } i.\]</div>
...
\[\operatorname{disc}(KL) = \operatorname{disc}(K)^\ell \cdot \operatorname{disc}(L)^k.\]</div>
