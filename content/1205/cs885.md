...
<div class="fancy-block-content">
    ...
    \[
        \|H^<em> (\tilde V) - H^</em> (V)\|_ \infty \le \gamma \|\tilde V - V \|_ \infty
    \]
</div></div>
...
<div class="fancy-block-content">
    ...
    \[
        \lim_ {n\to\infty } {H^<em> }^{(n)} (V) = V^</em> \quad \forall V
    \]
</div></div>
...
<div class="fancy-block"  data-type="Theorem">
<div class="fancy-block-content">
    Policy iteration converges to \(\pi^<em> ~\&~V^</em> \) in finitely many iterations when \(S \) and \(A \) are finite.
</div></div>
