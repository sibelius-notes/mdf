---
title: "ECON 231: Introduction to International Economics"
prof: "Wokia Kumase"
subjects: "ECON"
---
...
<strong>Comparative advantage:</strong> A country has a comparative advantage in producing good X if its opportunity cost of producing X (in terms of other goods forgone) is lower than in its trading partner. Countries should specialize in and export goods in which they have a comparative advantage, regardless of absolute productivity levels.
</div>
...
<div class="theorem">
<strong>Ricardian Gains from Trade:</strong> Provided that autarky relative prices differ between countries, trade allows both countries to consume combinations of goods that lie beyond their respective production possibility frontiers. Both countries gain from trade relative to autarky.
</div>
...
1. It predicts complete specialization, which is rarely observed in practice.
2. It has only one factor of production (labor), so it cannot address income distribution questions.
3. It does not explain intra-industry trade.
...
<div class="theorem">
<strong>Specific Factors Distributional Result:</strong> A rise in the relative price of a good unambiguously benefits the factor specific to that sector and harms the factor specific to the other sector. The effect on the mobile factor (labor) is ambiguous and depends on consumption patterns.
</div>
...
<div class="definition">
<strong>Factor abundance:</strong> Country 1 is capital-abundant relative to Country 2 if \( K_1/L_1 > K_2/L_2 \), i.e., if it has more capital per worker.
</div>

<div class="definition">
<strong>Factor intensity:</strong> Good X is capital-intensive relative to good Y if, at any given factor prices, production of X uses a higher capital-to-labor ratio: \( K_X/L_X > K_Y/L_Y \).
</div>

## 4.2 The Heckscher-Ohlin Theorem

<div class="theorem">
<strong>Heckscher-Ohlin Theorem:</strong> A country exports the good that uses its abundant factor intensively. A capital-abundant country exports the capital-intensive good; a labor-abundant country exports the labor-intensive good.
</div>
...
<div class="theorem">
<strong>Samuelson's Factor Price Equalization (FPE) Theorem:</strong> Under free trade, if both countries produce both goods and face the same goods prices, factor prices (wages and rental rates) will be equalized across countries, regardless of factor endowments.
</div>
...
<div class="theorem">
<strong>Stolper-Samuelson Theorem:</strong> An increase in the relative price of a good raises the real return to the factor used intensively in that good's production and lowers the real return to the other factor — in absolute terms, not just relative to the price change.
</div>
...
<div class="theorem">
<strong>Rybczynski Theorem:</strong> At constant goods prices, an increase in the endowment of one factor causes the output of the good that uses that factor intensively to expand and the output of the other good to contract (in absolute terms).
</div>
...
<div class="definition">
<strong>Terms of Trade:</strong> The relative price of a country's exports in terms of its imports. An improvement in the terms of trade (exports becoming more expensive relative to imports) raises real income.
</div>
...
<div class="definition">
<strong>External economies of scale:</strong> Cost reductions that arise when an industry (not an individual firm) grows larger — e.g., due to labor market pooling, knowledge spillovers, or specialized suppliers clustering near each other.
</div>

<div class="definition">
<strong>Internal economies of scale:</strong> Cost reductions that occur within an individual firm as it expands output. Internal economies of scale lead naturally to imperfect competition (large firms have a cost advantage).
</div>
...
1. **More variety:** Consumers can buy varieties produced in both countries
2. **Lower prices:** Larger scale production reduces average costs

<div class="theorem">
<strong>Gains from Trade with Increasing Returns:</strong> Even two identical countries can gain from trade in a monopolistically competitive industry. Trade allows firms to specialize in different varieties, exploit scale economies, and offer consumers a wider product range at lower prices.
</div>
...
1. **Income distribution:** Trade creates winners and losers. Even if aggregate gains are positive, those who lose (e.g., workers in import-competing industries) may have political power and lobby for protection.
2. **Collective action:** The losses from protection are concentrated among few producers (easy to organize politically) while the gains from free trade are diffuse (hard to mobilize).
3. **Information and visibility:** Job losses in specific factories from import competition are visible; the dispersed consumer gains from lower prices are invisible.
...
<div class="definition">
<strong>Exchange rate:</strong> The price of one currency in terms of another. The nominal exchange rate \( E \) is typically quoted as units of domestic currency per unit of foreign currency (e.g., 1.35 CAD per USD).
</div>
...
<div class="definition">
<strong>Real exchange rate:</strong> \( q = E \cdot \frac{P^*}{P} \), where \( P^* \) is the foreign price level and \( P \) is the domestic price level. The real exchange rate measures the relative price of foreign goods in terms of domestic goods.
</div>
...
## 10.4 Covered vs. Uncovered Interest Parity
...
<div class="theorem">
<strong>Absolute PPP:</strong> The exchange rate equals the ratio of price levels: \( E = P/P^* \). In other words, a basket of goods should cost the same in both countries when expressed in a common currency.
</div>
...
1. **Short run:** Prices fixed, money supply \( \uparrow \) → interest rate \( \downarrow \) → UIP requires expected appreciation → spot rate overshoots (depreciates by more than long-run amount)
2. **Long run:** Prices rise proportionally, real money supply returns to normal, interest rate back to \( i^* \), exchange rate appreciates back to PPP-consistent level

<div class="theorem">
<strong>Dornbusch Overshooting:</strong> A permanent increase in the money supply causes the exchange rate to depreciate in the short run by <em>more</em> than the long-run amount. This excess depreciation is necessary to satisfy UIP given the sticky-price response of the interest rate.
</div>
...
<div class="definition">
<strong>Current Account (CA):</strong> Records trade in goods (trade balance), services, primary income (investment income), and secondary income (transfers). A current account surplus means the country is a net lender to the rest of the world.
</div>

<div class="definition">
<strong>Capital and Financial Account (KFA):</strong> Records cross-border transactions in assets — foreign direct investment, portfolio investment (stocks and bonds), and other investment (bank loans). A financial account surplus (net capital inflow) finances a current account deficit.
</div>
