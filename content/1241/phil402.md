---
title: "PHIL 402: Standpoint Theory: Formation, Contestation, Legacies"
prof: "Alison Wylie"
subjects: "PHIL"
---
...
<strong>Standpoint (立场)</strong>: An <em>achieved</em> epistemic position, not a mere perspective passively occupied by virtue of social location. A standpoint requires critical reflection, collective political struggle, and the development of counter-hegemonic interpretive frameworks. It is an accomplishment, not a birthright.
</div>
...
1. **The Situated Knowledge Thesis** (情境知识论题): All knowledge is produced from particular social locations. There is no "view from nowhere." Gender, race, class, sexuality, and other axes of social position shape what questions are asked, what evidence is deemed relevant, and what interpretive frameworks are available.

2. **The Epistemic Advantage Thesis** (认识优势论题): Marginalized social positions can afford epistemic advantages — not automatically, but under conditions of critical reflection. Those who experience structures of domination from below have access to aspects of social reality that are systematically obscured from dominant vantage points.

3. **The Achievement Thesis** (认识成就论题): A standpoint is not a passive possession but an active accomplishment. It must be collectively developed through political engagement, consciousness-raising, and the construction of alternative interpretive resources.
...
<div class="definition">
<strong>Feminist standpoint (女性主义立场)</strong>: The epistemically generative position achieved through critical reflection on women's distinctive experiences within the sexual division of labour. Hartsock argues that this standpoint reveals the partiality and perversity of the dominant (male) worldview that abstracts from material reality and naturalizes relations of domination.
</div>
...
<div class="example">
<strong>Smith's autobiographical illustration.</strong> As a graduate student and young mother in the 1960s, Smith experienced the disjuncture between the abstract categories of sociology — designed to describe social structures from a detached, administrative vantage point — and the concrete, messy, embodied reality of managing a household, caring for children, and negotiating the material conditions of everyday life. Sociology's conceptual apparatus, she realized, was not merely incomplete; it actively suppressed the knowledge embedded in women's everyday practices.
</div>
...
<div class="definition">
<strong>The God Trick (上帝视角把戏)</strong>: Haraway's term for the epistemological illusion that knowledge can be produced from a disembodied, universal vantage point. The God trick renders its own partiality invisible by claiming to see everything from nowhere, thereby concealing the social interests and power relations embedded in its purportedly neutral gaze.
</div>
...
<div class="definition">
<strong>Strong objectivity (强客观性)</strong>: Harding's reconceptualization of objectivity as requiring that the social location of the knower be subjected to the same critical scrutiny as the object of inquiry. Traditional "weak objectivity" examines only the context of justification; strong objectivity extends critical inquiry to the context of discovery, asking how the social position of researchers shapes the questions they ask, the evidence they recognize, and the interpretations they favour.
</div>
...
<div class="example">
<strong>The domestic worker's perspective.</strong> Collins draws on the historical experience of Black domestic workers in white households to illustrate the outsider-within concept. These women had intimate knowledge of white families' lives — their contradictions, hypocrisies, and vulnerabilities — while remaining invisible as full persons to their employers. Their epistemic position was not one of ignorance but of a distinctive, marginalised knowledge that the dominant group actively refused to acknowledge.
</div>
...
1. **Self-definition and self-valuation**: Black women develop independent assessments of their own worth in opposition to the **controlling images** (控制性形象) — the mammy, the matriarch, the welfare queen — through which the dominant culture represents them.
2. **The interlocking nature of oppression**: The outsider-within standpoint reveals that race, class, and gender do not operate as independent axes of domination but as mutually constitutive systems — what Collins later calls the **matrix of domination** (支配矩阵).
3. **The importance of Black women's culture**: Everyday cultural practices — storytelling, blues music, the ethic of caring — serve as repositories of knowledge and resistance.
...
1. **Equal rights**: demanding inclusion within the existing system on the same terms as the dominant group.
2. **Revolutionary**: seeking to overthrow the existing system and replace it with an alternative.
3. **Supremacist**: affirming the superiority of the subordinated group's culture, values, or identity.
4. **Separatist**: withdrawing from the dominant system to create autonomous spaces.
5. **Differential**: the meta-strategy that moves among the other four as circumstances require.
...
<div class="remark">
<strong>Standpoint theory complicated.</strong> Sandoval's framework poses a productive challenge to standpoint theory as formulated by Hartsock and Collins. If the epistemic advantage of the marginalized derives from a <em>stable</em> social location, what happens when the most marginalized subjects are those whose consciousness is defined precisely by its <em>mobility</em> — its refusal to settle into any fixed position? Sandoval's work suggests that the achievement thesis may need to be rethought in terms of flexible, tactical capacities rather than settled epistemic positions.
</div>
...
<div class="remark">
<strong>Connecting Bell to standpoint theory.</strong> Bell's contribution to the seminar is to show that the epistemic disadvantage of the marginalized is not merely a matter of lacking knowledge; it is equally a matter of being <em>denied standing</em> as a knower. The standpoint thesis must therefore address not only the generation of knowledge but also the social conditions under which knowledge claims are heard, credited, and taken up.
</div>
...
<div class="remark">
<strong>Narayan's contribution to collaborative practice.</strong> Narayan's analysis remains essential reading for anyone engaged in community-based, participatory, or decolonizing research. Her account of the emotional dynamics of cross-difference dialogue — the anger, frustration, guilt, and defensiveness that arise when epistemic asymmetries become explicit — provides a framework for thinking about the <em>affective conditions</em> of knowledge production that purely epistemological analyses tend to overlook.
</div>
...
<div class="remark">
<strong>Collins's key intervention.</strong> Collins insists that standpoint theory was never primarily about truth or method — Hekman's chosen framing — but about <em>power</em>. The question is not "whose perspective is more accurate?" but "how do relations of domination structure what counts as knowledge, who is authorized to produce it, and whose claims are heard?" Hekman's critique, by abstracting from power, reproduces the very erasure that standpoint theory was designed to expose.
</div>
...
<div class="remark">
<strong>The Haack challenge.</strong> Haack forces standpoint theorists to clarify the nature of their claim. Is standpoint theory a thesis about the <em>sociology of knowledge</em> (how social location influences what people happen to believe) or a thesis about <em>epistemology</em> (how social location bears on the justification and truth of beliefs)? The former is relatively uncontroversial; the latter is the contentious and philosophically interesting claim. Standpoint theorists like Harding and Wylie argue that the distinction between sociology and epistemology is itself part of what standpoint theory challenges: the social conditions of knowledge production are epistemically relevant, not merely sociologically interesting.
</div>
...
1. **Intellectualism** (理智主义): the view that knowledge depends only on epistemic features (evidence, justification, truth) and not on non-epistemic features of the knower's situation.
2. **Atomism** (原子论): the view that knowers are independent, self-sufficient epistemic agents whose knowledge does not depend on their social relations.
3. **Aperspectivalism** (无视角主义): the view that genuine knowledge transcends the particular perspective of the knower.
...
<div class="definition">
<strong>Pragmatic encroachment (实用主义渗入)</strong>: The thesis in mainstream epistemology that practical considerations — not just evidential considerations — can affect whether a subject is in a position to know a proposition. Toole argues that social identity determines practical stakes, and therefore that standpoint epistemology is a natural extension of pragmatic encroachment rather than a radical departure from mainstream epistemology.
</div>
...
<div class="definition">
<strong>Willful hermeneutical ignorance (故意诠释学无知)</strong>: The active refusal by dominantly situated knowers to employ the interpretive resources developed by marginalized communities. Unlike Fricker's concept of hermeneutical injustice (a structural gap in collective interpretive resources), willful hermeneutical ignorance describes an <em>agential</em> phenomenon: dominantly situated knowers <em>choose</em> not to engage with available marginalized resources because doing so would threaten their epistemic comfort and social advantage.
</div>
...
<div class="example">
<strong>Epistemic apprenticeship in practice.</strong> Churcher's concept has concrete institutional implications. Consider a medical research programme designed to address health disparities affecting Indigenous communities. Under an epistemic apprenticeship model, the academic researchers would not merely "consult" community members or "include" them as subjects; they would undertake a sustained process of learning from community knowledge-holders, allowing community frameworks to shape research questions, methodologies, and interpretive standards. This requires institutional structures — funding models, timelines, evaluation criteria — that support long-term collaborative relationships rather than extractive, short-term research encounters.
</div>
