...
<strong>Pointer.</strong> A variable that stores the memory address of another variable. Declared with <code>*</code>, the address-of operator is <code>&</code>, and the dereference (indirection) operator is <code>*</code>.
