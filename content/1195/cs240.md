...
<div class="definition"><strong>Definition (Failure Array)</strong>: For pattern \(P[0..m-1]\), the <strong>failure array</strong> \(F[0..m-1]\) is defined by \[F[j] = \text{length of the longest proper prefix of } P \text{ that is also a suffix of } P[1..j].\]</div>
