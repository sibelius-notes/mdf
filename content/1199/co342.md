...
<div class="theorem"><strong>Proposition 5.2.4.</strong> If \(G\) is a \(k\)-regular bipartite graph with \(k \geq 1\), then \(G\) has a 1-factor (perfect matching), and its edges can be partitioned into \(k\) perfect matchings (a **1-factorization**).</div>
...
<div class="theorem"><strong>Theorem 5.2.5</strong> (2-Factor Theorem). Every 2\(k\)-regular graph \(G\) (\(k \geq 1\)) has a 2-factor. Moreover, \(E(G)\) can be partitioned into \(k\) 2-factors (a **2-factorization**).</div>
...
<div class="definition"><strong>Definition 6.2.2</strong> (Fundamental Cut). Let \(G\) be connected and \(T\) a spanning tree. For each tree edge \(e \in T\), removing \(e\) splits \(T\) into two components; the **fundamental cut** \(\delta_T(e)\) is the cut in \(G\) separating these two components.</div>
...
<div class="definition"><strong>Definition 6.2.4</strong> (Cycle Space). The <strong>cycle space</strong> \(\mathcal{C}(G)\) of \(G\) is the subspace of \(\mathcal{E}(G)\) spanned by all cycles. Equivalently, \(\mathcal{C}(G)\) consists of all **even subgraphs** — spanning subgraphs where every vertex has even degree.</div>
...
<div class="definition"><strong>Definition 6.2.5</strong> (Fundamental Cycle). Let \(G\) be connected and \(T\) a spanning tree. For each non-tree edge \(e \in E(G) \setminus T\), the **fundamental cycle** \(C_T(e)\) is the unique cycle in \(T \cup \{e\}\).</div>
