...
<div class="theorem"><strong>Proposition 4.10.1.</strong> For any plane graph \(G\), the dual \(G^<em>\) is also a plane graph, and \((G^</em>)^* \cong G\) whenever \(G\) is connected.</div>
...
<ul>
<li>If \(e\) is not a cut edge, then \((G - e)^<em> \cong G^</em> / e^*\).</li>
<li>If \(e\) is not a loop, then \((G / e)^<em> \cong G^</em> - e^*\).</li>
</ul></div>
...
<ul>
<li>If \(C\) is a cycle in \(G\), then \(C^<em> = \{e^</em> : e \in C\}\) is a bond in \(G^*\).</li>
<li>If \(B\) is a bond in \(G\), then \(B^<em> = \{e^</em> : e \in B\}\) is a cycle in \(G^*\).</li>
</ul>
Consequently, the cycle space of \(G\) equals the cut space of \(G^<em>\), and the cut space of \(G\) equals the cycle space of \(G^</em>\).</div>
...
This is yet another characterization of planarity — this time in terms of the algebraic relation between cycles and bonds. The forward direction follows from the plane dual construction above. The reverse uses MacLane's theorem (below): if \(G\) has an abstract dual \(G^<em>\), then the cycle space of \(G\) equals the cut space of \(G^</em>\), and the cuts of any graph are spanned by the \(\delta(v)\) (the edge-cuts at individual vertices), each edge appearing in at most two such cuts — giving a 2-basis for the cycle space of \(G\), hence \(G\) is planar by MacLane's theorem.
...
<div class="definition"><strong>Definition 6.2.1</strong> (Cut Space). The <strong>cut space</strong> \(\mathcal{C}^<em>(G)\) of \(G\) is the subspace of \(\mathcal{E}(G)\) consisting of all cuts: \(\mathcal{C}^</em>(G) = \{\delta(S) : S \subseteq V(G)\}\), where \(\delta(S)\) denotes the set of edges with exactly one endpoint in \(S\).</div>
...
What spans the cut space? Every cut is a disjoint union of <strong>bonds</strong> (minimal cuts), so the set of all bonds spans \(\mathcal{C}^<em>(G)\). To find a </em>basis*, we use spanning trees.
...
<div class="theorem"><strong>Theorem 6.2.3.</strong> The fundamental cuts \(\{\delta_T(e) : e \in T\}\) form a basis for \(\mathcal{C}^<em>(G)\). If \(G\) has \(k\) components, then \(\dim \mathcal{C}^</em>(G) = |V(G)| - k\).</div>
...
<div class="theorem"><strong>Theorem 6.2.7</strong> (Orthogonal Complement). \(\mathcal{C}^<em>(G)^\perp = \mathcal{C}(G)\) and \(\mathcal{C}(G)^\perp = \mathcal{C}^</em>(G)\).</div>
...
<strong>Theorem 6.2.8.</strong> Let \(\mathcal{C}^<em>(G)\) denote the cut space of a planar graph \(G\) and \(\mathcal{C}(G^</em>)\) the cycle space of its planar dual \(G^<em>\). Then \(\mathcal{C}^</em>(G) = \mathcal{C}(G^<em>)\) and \(\mathcal{C}(G) = \mathcal{C}^</em>(G^*)\).
