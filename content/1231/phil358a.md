---
title: "PHIL 358a: Scientific Discovery"
prof: "Doreen Fraser"
subjects: "PHIL"
---
...
<strong>Discovery (preliminary characterization)</strong>: A scientific discovery is the cognitive event or process by which a scientist or community first achieves warranted access to a new scientific item — whether an observational fact, a causal relationship, a natural kind, or a theoretical structure. The term can refer both to the moment of insight and to the extended process of investigation that culminates in recognition.
</div>
...
<div class="remark">
<strong>Course orientation</strong>: This course treats discovery as genuinely philosophically tractable. We aim not merely to describe how discoveries happen, but to assess whether there are methods, heuristics, or inferential patterns that can be evaluated as better or worse for the purposes of generating new scientific knowledge. Whether such evaluation is possible — and what constraints it must satisfy — is the central contested question throughout the course.
</div>
...
<div class="definition">
<strong>Context of discovery</strong>: The actual psychological, sociological, and historical processes by which a scientist comes to entertain or propose a new hypothesis or theory. This context includes inspiration, intuition, biographical circumstance, and institutional setting.

<strong>Context of justification</strong>: The logical and evidential relations that determine whether a proposed hypothesis is warranted, confirmed, or acceptable in light of available evidence. This context is the proper domain of epistemology and philosophy of science.
</div>
...
<div class="remark">
<strong>Kuhn's own position on discovery</strong>: Kuhn does not simply reject the distinction; he complicates it. His account of paradigms, anomalies, and revolutions provides a structured narrative of how major discoveries come about — a narrative with its own internal logic. The Kuhnian challenge is not that discovery is irrational, but that the rationality of discovery cannot be understood independently of the rationality of paradigm-relative normal science.
</div>
...
<div class="remark">
<strong>Methodological note</strong>: The Reichenbachian distinction is best understood not as a claim about how science actually works, but as a prescriptive claim about where philosophy of science should direct its attention. Criticisms of the distinction often succeed in showing that philosophy of science should attend to discovery; they do not necessarily show that justificatory analysis is unimportant.
</div>
...
<div class="example">
<strong>Example — Popper's falsificationism and discovery</strong>: Suppose a physicist proposes the hypothesis that all metals expand when heated. On Popper's account, the rationality of science lies entirely in the subsequent testing of this hypothesis: subjecting it to experimental attempts at refutation, designing crucial experiments, and rejecting it if a counterinstance is found. How the physicist came to entertain this hypothesis — by analogy, by induction over past cases, by a dream — is epistemologically irrelevant. Science advances by bold conjecture and ruthless refutation, not by methodical discovery.
</div>
...
<div class="definition">
<strong>Theory-ladenness of observation</strong>: The thesis that all scientific observation is conceptually mediated — that what a scientist observes is not a brute sensory given but is already organized and interpreted through the theoretical vocabulary and background assumptions of the observer's scientific community.
</div>
...
<div class="definition">
<strong>Peirce's three inferential forms (mature formulation)</strong>:

<strong>Deduction</strong>: From a rule and a case, infer a result. (All metals expand when heated; this is a metal; therefore, this will expand when heated.)

<strong>Induction</strong>: From cases and results, infer a rule. (These metals have all expanded when heated; therefore, all metals expand when heated.)

<strong>Abduction (retroduction)</strong>: From a surprising result and a rule, infer a case. (This phenomenon is surprising; but if hypothesis H were true, the phenomenon would be a matter of course; therefore, H is worth entertaining.)
</div>
...
<div class="example">
<strong>Example — Hanson's reading of Kepler</strong>: Kepler's path to the laws of planetary motion exemplifies abductive reasoning. Faced with the systematic discrepancy between Tycho's precise observations and the predictions of circular orbit models, Kepler did not treat this discrepancy as measurement error. He treated it as a significant anomaly demanding a new hypothesis. The move to elliptical orbits was not an inductive generalization from the data but an abductive inference: the ellipse hypothesis was adopted because it made the anomalous data intelligible as a systematic result.
</div>
...
<div class="definition">
<strong>Anomaly (Kuhn)</strong>: A phenomenon or result that violates the paradigm-induced expectations of normal science in a way that cannot be resolved by minor adjustments to the paradigm. The recognition of anomaly is a necessary precondition for revolutionary discovery.

<strong>Crisis</strong>: The state of scientific practice that obtains when anomalies become sufficiently severe and prolonged that the paradigm's authority is openly questioned. Crisis is the condition within which extraordinary science — including revolutionary discovery — becomes possible.
</div>
...
<div class="example">
<strong>Example — Anomaly and crisis in the Copernican revolution</strong>: The calendar anomaly in late medieval astronomy serves as an illustration. The Julian calendar had accumulated a discrepancy between the astronomical year and the calendar year that was large enough to affect the dating of Easter. This discrepancy was an anomaly within the Ptolemaic framework — it could not be fully resolved without either abandoning the Earth-centered model or introducing ever more complex epicyclical adjustments. Copernicus recognized this as an anomaly that called for a fundamentally new approach, not merely further adjustment.
</div>
...
<div class="example">
<strong>Example — Lavoisier and oxygen</strong>: Kuhn's account of Lavoisier's discovery of oxygen illustrates the gestalt character of revolutionary discovery. Priestley, working within the phlogiston paradigm, had prepared oxygen but described it as "dephlogisticated air." He saw the new substance through the lens of the existing theory. Lavoisier, achieving a gestalt shift, saw the same substance as evidence for a fundamentally different theory of combustion — one that eliminated phlogiston altogether. The difference was not access to better data but a reorganization of the entire conceptual framework within which the data was interpreted.
</div>
...
<div class="example">
<strong>Example — Kekulé's benzene ring</strong>: The structural formula of benzene (C6H6) had long resisted explanation because the carbon-to-hydrogen ratio implied more unsaturation than was consistent with benzene's known chemical stability and reactivity. Kekulé's insight — that the six carbon atoms form a closed ring, with alternating single and double bonds — resolved this anomaly. The ring structure was not derived by straightforward induction from experimental data; it required a conceptual innovation that restructured the problem space of organic chemistry.
</div>
...
<div class="remark">
<strong>Remark — Serendipity and method</strong>: Röntgen's case challenges simple accounts of discovery as rule-following, but it does not vindicate the view that discovery is purely accidental. The recognition of the fluorescence as significant, the inference that an unknown radiation was responsible, and the systematic investigation that followed all exhibit rational structure. Serendipity provides an opportunity; expertise and method determine whether that opportunity is seized.
</div>
...
<div class="example">
<strong>Example — Constraints and model building in DNA discovery</strong>: The double-helix model satisfied several independent constraint sets simultaneously. Chargaff's rules (A pairs with T, G pairs with C in equal proportions) were explained by the complementary base-pairing of the antiparallel strands. Franklin's X-ray data constrained the backbone geometry and the number of strands. The biological requirement of faithful replication was elegantly met by the complementarity of the two strands. The discovery was not a single abductive inference but a convergence of multiple independent constraints on a unique model.
</div>
...
<div class="definition">
<strong>Heuristic</strong>: A rule or procedure that guides search through a problem space in a way that is effective on average, without guaranteeing optimal solutions or logical certainty. Heuristics reduce the combinatorial explosion of possibilities by focusing search on promising regions of the problem space.

<strong>Problem space</strong>: The formal representation of a discovery or problem-solving task, consisting of an initial state (current knowledge), a goal state (target knowledge), and operators (permitted moves from state to state).
</div>
...
<div class="example">
<strong>Example — BACON and Kepler's third law</strong>: Given a table of data on planetary periods and orbital radii, BACON applied its covariation heuristic and detected that the ratio \( P^2/R^3 \) was approximately constant across planets. This is precisely Kepler's third law. BACON did not prove the law or explain why it holds; it detected a pattern in data by applying a systematic search strategy. Simon argued this is a fair model of what Kepler himself did, at least in part.
</div>
...
<div class="definition">
<strong>Analogical inference in discovery</strong>: Given that source domain S has properties P₁, P₂, ..., Pₙ and that target domain T shares P₁, ..., Pₙ₋₁ with S, infer that T probably also has Pₙ. In discovery contexts, the analog from S to T generates a hypothesis about T that is then subjected to independent evaluation.
</div>
...
<div class="example">
<strong>Example — Maxwell and the displacement current</strong>: Maxwell's mechanical analogy with rotating vortices required the introduction of a "displacement current" to maintain consistency: when the electric field in a region changes, even in the absence of actual charge flow, there should be an effective current associated with the changing field. Maxwell had no direct experimental evidence for displacement currents; they were a theoretical requirement of the mechanical model. But including them in the equations yielded a result of extraordinary importance: the equations admitted wave solutions propagating at the speed of light \[ c = \frac{1}{\sqrt{\mu_0 \varepsilon_0}} \] This prediction, confirmed experimentally by Hertz in 1887, was a landmark in the history of physics and a triumph of analogical reasoning.
</div>
...
<div class="example">
<strong>Example — Sound and light waves</strong>: Christian Huygens's wave theory of light was developed partly by analogy with the well-understood behavior of sound waves. Sound propagates through a medium as a wave; perhaps light does too. The analogy suggested specific predictions — diffraction, interference, polarization — which were subsequently confirmed experimentally. The analogy also generated a productive research program: the search for the luminiferous ether, which, though ultimately unsuccessful, organized a century of optical inquiry.
</div>
...
<div class="remark">
<strong>Remark — Tacit knowledge and AI models of discovery</strong>: Simon's computational account and Polanyi's tacit knowledge account represent opposing poles of a spectrum. Simon emphasizes the formalizable, rule-governed aspects of discovery; Polanyi emphasizes the irreducibly personal, embodied, and non-articulable aspects. A fully adequate philosophy of discovery will need to account for both, and to explain how they interact in actual scientific practice.
</div>
...
1. **The logical question**: Is there a formal inferential pattern — like abduction — that characterizes the generation of scientific hypotheses?
2. **The methodological question**: Are there normative guidelines — heuristics, rules of thumb, or strategies — that reliably improve the prospects of discovery?
3. **The evaluative question**: Are there criteria by which discovery processes can be assessed as more or less rational, more or less fruitful?
...
<div class="definition">
<strong>Methodological pluralism about discovery</strong>: The view that scientific discovery is not governed by a single universal method, but that multiple discovery strategies — abductive inference, analogical reasoning, heuristic search, model building, experimental variation — are each rational, each valuable in appropriate contexts, and each amenable to normative assessment.
</div>
...
<div class="remark">
<strong>Concluding remark</strong>: The philosophy of scientific discovery has matured considerably since Reichenbach's dismissal of the context of discovery as epistemologically irrelevant. The field now encompasses logical analysis (Peirce, Hanson), structural history of science (Kuhn), computational modeling (Simon), analogical epistemology (Hesse, Maxwell), cognitive science (Polanyi), and historical case studies. The central question — whether there is a rational structure to discovery — remains contested, but the terms of the debate are far richer and more nuanced than the positivist consensus allowed.
