...
| <strong>Col Total</strong> | 125 | 150 | 125 | 100 | 500 |
...
<strong>Fitted model:</strong> \(\hat{\text{Revenue}} = 118.4 + 4.30 \times \text{AdSpend}\)

<strong>Interpretation:</strong> Each additional \$1{,}000 in advertising is associated with an estimated \$4{,}300 increase in monthly sales revenue, on average. The intercept of \$118{,}400 represents estimated revenue when advertising spend is zero — plausible as a baseline (brand recognition, repeat customers).
</div>
...
\[
\hat{y}^<em> \pm t_{\alpha/2,\, n-2} \cdot s_e \sqrt{\frac{1}{n} + \frac{(x^</em> - \bar{x})^2}{S_{xx}}}
\]
...
\[
\hat{y}^<em> \pm t_{\alpha/2,\, n-2} \cdot s_e \sqrt{1 + \frac{1}{n} + \frac{(x^</em> - \bar{x})^2}{S_{xx}}}
\]
