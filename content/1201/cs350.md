...
subjects: "CS"
---
miscellaneous notes... Also, check my [help page](/1201/cs350help) and the [Spring 2021 notes](/1215/cs350).
...
<svg viewBox="0 0 560 180" xmlns="http://www.w3.org/2000/svg" style="max-width:560px;display:block;margin:1.5em auto">
  <defs>
    <marker id="ts-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#3b82f6"/>
    </marker>
    <marker id="ts-arr2" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#22c55e"/>
    </marker>
    <marker id="ts-arr3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#ef4444"/>
    </marker>
    <style>.ts{font:11px sans-serif;fill:currentColor;text-anchor:middle;dominant-baseline:middle;font-weight:bold}
    .tl{font:9px sans-serif;fill:#94a3b8;text-anchor:middle;dominant-baseline:middle}</style>
  </defs>
  <!-- States: New(50,90), Ready(170,90), Running(290,90), Blocked(410,90), Terminated(530,90) -->
  <!-- New -->
  <ellipse cx="50" cy="90" rx="40" ry="26" fill="#1e293b" stroke="#94a3b8" stroke-width="1.5"/>
  <text x="50" y="90" class="ts" fill="#94a3b8">New</text>
  <!-- Ready -->
  <ellipse cx="190" cy="90" rx="46" ry="26" fill="#1e293b" stroke="#3b82f6" stroke-width="2"/>
  <text x="190" y="90" class="ts" fill="#3b82f6">Ready</text>
  <!-- Running -->
  <ellipse cx="350" cy="90" rx="52" ry="26" fill="#1e293b" stroke="#22c55e" stroke-width="2.2"/>
  <text x="350" y="90" class="ts" fill="#22c55e">Running</text>
  <!-- Blocked -->
  <ellipse cx="500" cy="38" rx="46" ry="24" fill="#1e293b" stroke="#facc15" stroke-width="1.8"/>
  <text x="500" y="38" class="ts" fill="#facc15">Blocked</text>
  <!-- Terminated -->
  <ellipse cx="500" cy="140" rx="54" ry="24" fill="#1e293b" stroke="#ef4444" stroke-width="1.8"/>
  <text x="500" y="140" class="ts" fill="#ef4444">Terminated</text>
  <!-- New → Ready (create) -->
  <line x1="90" y1="90" x2="142" y2="90" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#ts-arr)"/>
  <text x="116" y="82" class="tl">create</text>
  <!-- Ready → Running (schedule/dispatch) -->
  <line x1="236" y1="83" x2="296" y2="83" stroke="#22c55e" stroke-width="1.5" marker-end="url(#ts-arr2)"/>
  <text x="266" y="75" class="tl">dispatch</text>
  <!-- Running → Ready (preempt/yield) -->
  <line x1="298" y1="97" x2="238" y2="97" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#ts-arr)"/>
  <text x="268" y="110" class="tl">preempt/yield</text>
  <!-- Running → Blocked (wait/I/O) -->
  <line x1="392" y1="72" x2="456" y2="48" stroke="#facc15" stroke-width="1.5" marker-end="url(#ts-arr)"/>
  <text x="436" y="56" class="tl" fill="#facc15">block/wait</text>
  <!-- Blocked → Ready (event) -->
  <line x1="457" y1="50" x2="236" y2="82" stroke="#3b82f6" stroke-width="1.2" stroke-dasharray="5,3" marker-end="url(#ts-arr)"/>
  <text x="330" y="56" class="tl">event/wake</text>
  <!-- Running → Terminated (exit) -->
  <line x1="392" y1="108" x2="449" y2="128" stroke="#ef4444" stroke-width="1.5" marker-end="url(#ts-arr3)"/>
  <text x="436" y="126" class="tl" fill="#ef4444">exit</text>
</svg>
...
<svg viewBox="0 0 520 200" xmlns="http://www.w3.org/2000/svg" style="max-width:520px;display:block;margin:1.5em auto">
  <defs>
    ...
    <marker id="pc-arr2" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#22c55e"/>
    </marker>
    <style>.pc{font:10px sans-serif;fill:currentColor;text-anchor:middle;dominant-baseline:middle}</style>
  </defs>
  <!-- Producer threads (left) -->
  <rect x="10" y="40" width="90" height="28" rx="3" fill="#1e293b" stroke="#3b82f6" stroke-width="1.8"/>
  <text x="55" y="54" class="pc" fill="#3b82f6" font-weight="bold">Producer 1</text>
  <rect x="10" y="80" width="90" height="28" rx="3" fill="#1e293b" stroke="#3b82f6" stroke-width="1.8"/>
  <text x="55" y="94" class="pc" fill="#3b82f6" font-weight="bold">Producer 2</text>
  <rect x="10" y="120" width="90" height="28" rx="3" fill="#1e293b" stroke="#3b82f6" stroke-width="1.5" stroke-dasharray="4,2"/>
  <text x="55" y="134" class="pc" fill="#3b82f6">Producer N</text>
  <!-- Arrows producers → buffer -->
  <line x1="100" y1="54" x2="168" y2="90" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#pc-arr)"/>
  <line x1="100" y1="94" x2="168" y2="100" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#pc-arr)"/>
  <text x="124" y="78" class="pc" font-size="8.5" fill="#3b82f6">P(empty)</text>
  <text x="124" y="100" class="pc" font-size="8.5" fill="#3b82f6">V(full)</text>
  <!-- Bounded Buffer (center) -->
  <rect x="168" y="55" width="184" height="90" rx="4" fill="#1e293b" stroke="#facc15" stroke-width="2"/>
  <text x="260" y="72" class="pc" fill="#facc15" font-weight="bold">Bounded Buffer (n slots)</text>
  <!-- slots -->
  <rect x="178" y="82" width="25" height="22" rx="2" fill="#22c55e" fill-opacity="0.4" stroke="#22c55e" stroke-width="1"/>
  <rect x="207" y="82" width="25" height="22" rx="2" fill="#22c55e" fill-opacity="0.4" stroke="#22c55e" stroke-width="1"/>
  <rect x="236" y="82" width="25" height="22" rx="2" fill="#22c55e" fill-opacity="0.4" stroke="#22c55e" stroke-width="1"/>
  <rect x="265" y="82" width="25" height="22" rx="2" fill="none" stroke="#475569" stroke-width="1"/>
  <rect x="294" y="82" width="25" height="22" rx="2" fill="none" stroke="#475569" stroke-width="1"/>
  <rect x="323" y="82" width="25" height="22" rx="2" fill="none" stroke="#475569" stroke-width="1"/>
  <text x="260" y="122" class="pc" font-size="8.5" fill="#94a3b8">semaphore full=3, empty=3</text>
  <text x="260" y="135" class="pc" font-size="8.5" fill="#94a3b8">mutex guards buffer access</text>
  <!-- Arrows buffer → consumers -->
  <line x1="352" y1="90" x2="418" y2="54" stroke="#22c55e" stroke-width="1.5" marker-end="url(#pc-arr2)"/>
  <line x1="352" y1="100" x2="418" y2="94" stroke="#22c55e" stroke-width="1.5" marker-end="url(#pc-arr2)"/>
  <text x="396" y="78" class="pc" font-size="8.5" fill="#22c55e">P(full)</text>
  <text x="396" y="100" class="pc" font-size="8.5" fill="#22c55e">V(empty)</text>
  <!-- Consumer threads (right) -->
  <rect x="418" y="40" width="90" height="28" rx="3" fill="#1e293b" stroke="#22c55e" stroke-width="1.8"/>
  <text x="463" y="54" class="pc" fill="#22c55e" font-weight="bold">Consumer 1</text>
  <rect x="418" y="80" width="90" height="28" rx="3" fill="#1e293b" stroke="#22c55e" stroke-width="1.8"/>
  <text x="463" y="94" class="pc" fill="#22c55e" font-weight="bold">Consumer 2</text>
  <rect x="418" y="120" width="90" height="28" rx="3" fill="#1e293b" stroke="#22c55e" stroke-width="1.5" stroke-dasharray="4,2"/>
  <text x="463" y="134" class="pc" fill="#22c55e">Consumer M</text>
  <!-- Semaphore labels at bottom -->
  <text x="260" y="162" class="pc" font-size="9" fill="#facc15">Producer blocks when full; consumer blocks when empty</text>
  <text x="260" y="176" class="pc" font-size="9" fill="#94a3b8">mutex: P(mutex) before buf access, V(mutex) after</text>
</svg>
...
<svg viewBox="0 0 540 230" xmlns="http://www.w3.org/2000/svg" style="max-width:540px;display:block;margin:1.5em auto">
  <defs>
    <marker id="vm-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#3b82f6"/>
    </marker>
    <marker id="vm-arr2" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#22c55e"/>
    </marker>
    <marker id="vm-arrr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <polygon points="0 0,8 3,0 6" fill="#ef4444"/>
    </marker>
    <style>.vm{font:10px sans-serif;fill:currentColor;text-anchor:middle;dominant-baseline:middle}</style>
  </defs>
  <!-- CPU issues virtual address -->
  <rect x="10" y="100" width="80" height="30" rx="3" fill="#1e293b" stroke="#94a3b8" stroke-width="1.5"/>
  <text x="50" y="115" class="vm" fill="#94a3b8" font-weight="bold">CPU</text>
  <line x1="90" y1="115" x2="115" y2="115" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#vm-arr)"/>
  <text x="102" y="108" class="vm" font-size="8.5" fill="#3b82f6">VPN</text>
  <!-- MMU box -->
  <rect x="115" y="75" width="200" height="80" rx="4" fill="#1e293b" stroke="#3b82f6" stroke-width="2"/>
  <text x="215" y="92" class="vm" font-weight="bold" fill="#3b82f6">MMU</text>
  <!-- TLB inside MMU -->
  <rect x="130" y="100" width="80" height="40" rx="3" fill="#0f172a" stroke="#facc15" stroke-width="1.5"/>
  <text x="170" y="117" class="vm" fill="#facc15" font-weight="bold">TLB</text>
  <text x="170" y="130" class="vm" font-size="8" fill="#facc15">VPN→PFN cache</text>
  <!-- TLB Hit path: TLB → physical mem -->
  <line x1="315" y1="108" x2="355" y2="88" stroke="#22c55e" stroke-width="1.5" marker-end="url(#vm-arr2)"/>
  <text x="348" y="96" class="vm" font-size="8.5" fill="#22c55e" text-anchor="start">HIT→PFN</text>
  <!-- TLB Miss path: page table in RAM -->
  <line x1="315" y1="132" x2="355" y2="152" stroke="#ef4444" stroke-width="1.5" stroke-dasharray="5,2" marker-end="url(#vm-arrr)"/>
  <text x="358" y="155" class="vm" font-size="8.5" fill="#ef4444" text-anchor="start">MISS</text>
  <!-- Page Table in RAM -->
  <rect x="355" y="160" width="130" height="50" rx="3" fill="#1e293b" stroke="#ef4444" stroke-width="1.5"/>
  <text x="420" y="178" class="vm" fill="#ef4444" font-weight="bold">Page Table (RAM)</text>
  <text x="420" y="195" class="vm" font-size="8.5" fill="#94a3b8">VPN → PFN</text>
  <!-- Page table → update TLB -->
  <line x1="355" y1="175" x2="212" y2="143" stroke="#ef4444" stroke-width="1.2" stroke-dasharray="4,3" marker-end="url(#vm-arrr)"/>
  <text x="280" y="165" class="vm" font-size="8" fill="#ef4444">fill TLB</text>
  <!-- Physical memory -->
  <rect x="355" y="75" width="130" height="50" rx="3" fill="#1e293b" stroke="#22c55e" stroke-width="1.5"/>
  <text x="420" y="94" class="vm" fill="#22c55e" font-weight="bold">Physical Memory</text>
  <text x="420" y="110" class="vm" font-size="8.5" fill="#94a3b8">PFN + offset → data</text>
  <!-- Labels -->
  <text x="215" y="175" class="vm" font-size="9" fill="#94a3b8">Hit: 1 cycle (TLB only)</text>
  <text x="215" y="188" class="vm" font-size="9" fill="#94a3b8">Miss: ~100 cycles (RAM lookup)</text>
  <!-- Virtual address split label -->
  <text x="50" y="90" class="vm" font-size="8.5" fill="#94a3b8">Virtual Addr</text>
  <text x="50" y="78" class="vm" font-size="8">[VPN | offset]</text>
</svg>
...
It clears the TLB. See details [here](/1201/cs350help/#a2b) in A2b.
...
The scheduler decides which ready thread gets the CPU next. Two basic policies are **FCFS (First-Come, First-Served)** and **Round Robin (RR)** with a fixed quantum. FCFS is simple but can starve short jobs behind a long one. RR provides fairness by cycling through all ready threads.

![Process scheduling Gantt chart: FCFS vs Round Robin for P1(burst=6), P2(burst=4), P3(burst=2)](/pics/cs350_1201/scheduling-gantt.png)
