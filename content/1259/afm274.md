...
<strong>Decision rule:</strong> Accept the project if \(NPV > 0\); reject if \(NPV < 0\). For mutually exclusive projects, select the one with the highest positive NPV.
</div>
...
<strong>Decision rule:</strong> Accept the project if \(IRR > \text{required return (hurdle rate)}\); reject if \(IRR < \text{hurdle rate}\).
</div>
...
Payback = 2 + (150{,}000 / 220{,}000) = 2 + 0.68 = <strong>2.68 years</strong>
</div>
...
<strong>Decision rule:</strong> Accept if \(PI > 1\). Under capital rationing, rank projects by PI to maximize total NPV per dollar invested.
</div>
...
| <strong>Total</strong> | <strong>\$100{,}000{,}000</strong> | <strong>100%</strong> |
...
If NorthTech has net debt of \$40M, equity value = \$198.5M − \$40M = <strong>\$158.5M</strong>.
</div>
