...
<svg viewBox="0 0 480 200" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;display:block;margin:1.5em auto">
  <!-- Stack box -->
  <rect x="20" y="20" width="160" height="160" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <text x="100" y="14" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">Stack</text>
  <!-- stack frames -->
  <rect x="30" y="30" width="140" height="35" rx="2" fill="#3b82f620" stroke="#3b82f6" stroke-width="1"/>
  <text x="100" y="52" text-anchor="middle" font-size="11" fill="currentColor">ptr → 0x4a10</text>
  <rect x="30" y="75" width="140" height="35" rx="2" fill="#3b82f620" stroke="#3b82f6" stroke-width="1"/>
  <text x="100" y="97" text-anchor="middle" font-size="11" fill="currentColor">x = 42</text>
  <rect x="30" y="120" width="140" height="35" rx="2" fill="#3b82f620" stroke="#3b82f6" stroke-width="1"/>
  <text x="100" y="142" text-anchor="middle" font-size="11" fill="currentColor">y = 7</text>
  <!-- Heap box -->
  <rect x="280" y="20" width="180" height="160" rx="4" fill="none" stroke="#22c55e" stroke-width="1.5"/>
  <text x="370" y="14" text-anchor="middle" font-size="12" font-weight="bold" fill="#22c55e">Heap</text>
  <!-- heap objects -->
  <rect x="295" y="50" width="150" height="40" rx="2" fill="#22c55e20" stroke="#22c55e" stroke-width="1"/>
  <text x="370" y="65" text-anchor="middle" font-size="10" fill="currentColor">0x4a10: Node {val=5}</text>
  <text x="370" y="82" text-anchor="middle" font-size="10" fill="currentColor">(new Node(5))</text>
  <rect x="295" y="115" width="150" height="40" rx="2" fill="#22c55e20" stroke="#22c55e" stroke-width="1"/>
  <text x="370" y="130" text-anchor="middle" font-size="10" fill="currentColor">0x4b20: int[10]</text>
  <text x="370" y="148" text-anchor="middle" font-size="10" fill="currentColor">(new int[10])</text>
  <!-- arrow from stack ptr to heap object -->
  <line x1="170" y1="47" x2="293" y2="68" stroke="#ef4444" stroke-width="1.8" marker-end="url(#arr)"/>
  <defs>
    <marker id="arr" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#ef4444"/>
    </marker>
  </defs>
  <text x="240" y="193" text-anchor="middle" font-size="10" fill="currentColor">Heap vs Stack: pointer on stack → object on heap</text>
</svg>
...
## The Preprocessor
Both C and C++ use a tool called the **C preprocessor**, which is tasked with handling **preprocessor directives** like `#include`. See more explanations in Section 4.2 of [cs 146](https://pdf.sibeliusp.com/1211/cs146.pdf). See some discussions in Section 2.1 of [cs 246e](https://pdf.sibeliusp.com/1189/cs246e.pdf).
...
**Static members** are associated with the class itself, and not with any particular instance (object) of the class. More discussion see Section 6.1 of [cs 146](https://pdf.sibeliusp.com/1211/cs146.pdf).
...
This is an example of `const` overloading. Check Chapter 6 of [cs 246e](https://pdf.sibeliusp.com/1189/cs246e.pdf).
...
<svg viewBox="0 0 460 240" xmlns="http://www.w3.org/2000/svg" style="max-width:460px;display:block;margin:1.5em auto">
  <!-- Animal (base) -->
  <rect x="160" y="10" width="140" height="80" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <line x1="160" y1="32" x2="300" y2="32" stroke="currentColor" stroke-width="1"/>
  <line x1="160" y1="58" x2="300" y2="58" stroke="currentColor" stroke-width="1"/>
  <text x="230" y="26" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Animal</text>
  <text x="168" y="48" font-size="11" fill="currentColor">– name: string</text>
  <text x="168" y="72" font-size="11" fill="currentColor">+ speak(): void</text>
  <!-- Dog (subclass) -->
  <rect x="30" y="160" width="130" height="70" rx="4" fill="none" stroke="#3b82f6" stroke-width="1.5"/>
  <line x1="30" y1="180" x2="160" y2="180" stroke="#3b82f6" stroke-width="1"/>
  <line x1="30" y1="205" x2="160" y2="205" stroke="#3b82f6" stroke-width="1"/>
  <text x="95" y="174" text-anchor="middle" font-size="13" font-weight="bold" fill="#3b82f6">Dog</text>
  <text x="38" y="196" font-size="11" fill="currentColor">– breed: string</text>
  <text x="38" y="220" font-size="11" fill="currentColor">+ speak(): void</text>
  <!-- Cat (subclass) -->
  <rect x="300" y="160" width="130" height="70" rx="4" fill="none" stroke="#22c55e" stroke-width="1.5"/>
  <line x1="300" y1="180" x2="430" y2="180" stroke="#22c55e" stroke-width="1"/>
  <line x1="300" y1="205" x2="430" y2="205" stroke="#22c55e" stroke-width="1"/>
  <text x="365" y="174" text-anchor="middle" font-size="13" font-weight="bold" fill="#22c55e">Cat</text>
  <text x="308" y="196" font-size="11" fill="currentColor">– indoor: bool</text>
  <text x="308" y="220" font-size="11" fill="currentColor">+ speak(): void</text>
  <!-- inheritance arrows (open triangle to Animal) -->
  <line x1="95" y1="160" x2="210" y2="92" stroke="currentColor" stroke-width="1.5"/>
  <polygon points="210,92 200,105 220,105" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <line x1="365" y1="160" x2="250" y2="92" stroke="currentColor" stroke-width="1.5"/>
  <polygon points="250,92 240,105 260,105" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <text x="230" y="235" text-anchor="middle" font-size="10" fill="currentColor">UML Class Diagram: Inheritance (Is-A)</text>
</svg>
...
To avoid circular includes, one can use **forward declaration**. Check page 112 of [CS 246E](https://pdf.sibeliusp.com/1189/cs246e.pdf) for a full discussion.

**Virtual dispatch** works through a hidden vtable pointer in each object. When a `virtual` method is called, the runtime looks up the function pointer in the object's vtable:

<svg viewBox="0 0 480 220" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;display:block;margin:1.5em auto">
  <!-- Object on stack -->
  <rect x="20" y="40" width="130" height="70" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <text x="85" y="30" text-anchor="middle" font-size="11" font-weight="bold" fill="currentColor">Object (Book)</text>
  <line x1="20" y1="60" x2="150" y2="60" stroke="currentColor" stroke-width="1"/>
  <text x="85" y="54" text-anchor="middle" font-size="10" fill="#ef4444">vptr →</text>
  <text x="85" y="78" text-anchor="middle" font-size="10" fill="currentColor">title: string</text>
  <text x="85" y="96" text-anchor="middle" font-size="10" fill="currentColor">pages: int</text>
  <!-- vtable for Book -->
  <rect x="220" y="20" width="150" height="80" rx="4" fill="none" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="295" y="14" text-anchor="middle" font-size="11" font-weight="bold" fill="#3b82f6">Book's vtable</text>
  <line x1="220" y1="40" x2="370" y2="40" stroke="#3b82f6" stroke-width="1"/>
  <text x="295" y="56" text-anchor="middle" font-size="10" fill="currentColor">isHeavy → Book::isHeavy</text>
  <text x="295" y="74" text-anchor="middle" font-size="10" fill="currentColor">print  → Book::print</text>
  <!-- vtable for Text (subclass) -->
  <rect x="220" y="130" width="150" height="65" rx="4" fill="none" stroke="#22c55e" stroke-width="1.5"/>
  <text x="295" y="124" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">Text's vtable</text>
  <line x1="220" y1="148" x2="370" y2="148" stroke="#22c55e" stroke-width="1"/>
  <text x="295" y="163" text-anchor="middle" font-size="10" fill="currentColor">isHeavy → Text::isHeavy</text>
  <text x="295" y="181" text-anchor="middle" font-size="10" fill="currentColor">print  → Book::print</text>
  <!-- vptr arrow to Book vtable -->
  <line x1="150" y1="55" x2="218" y2="55" stroke="#ef4444" stroke-width="1.8" marker-end="url(#ra)"/>
  <defs>
    <marker id="ra" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#ef4444"/>
    </marker>
  </defs>
  <text x="240" y="210" text-anchor="middle" font-size="10" fill="currentColor">Virtual dispatch: vptr in object → vtable → function pointer</text>
</svg>
...
<svg viewBox="0 0 500 260" xmlns="http://www.w3.org/2000/svg" style="max-width:500px;display:block;margin:1.5em auto">
  <!-- Subject (Observable) -->
  <rect x="170" y="10" width="160" height="75" rx="4" fill="none" stroke="currentColor" stroke-width="1.5"/>
  <line x1="170" y1="30" x2="330" y2="30" stroke="currentColor" stroke-width="1"/>
  <line x1="170" y1="52" x2="330" y2="52" stroke="currentColor" stroke-width="1"/>
  <text x="250" y="24" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">Subject</text>
  <text x="178" y="44" font-size="10" fill="currentColor">observers: list</text>
  <text x="178" y="66" font-size="10" fill="currentColor">attach(o) / notify()</text>
  <!-- Observer (abstract) -->
  <rect x="170" y="130" width="160" height="55" rx="4" fill="none" stroke="#3b82f6" stroke-width="1.5" stroke-dasharray="5,3"/>
  <line x1="170" y1="150" x2="330" y2="150" stroke="#3b82f6" stroke-width="1"/>
  <text x="250" y="144" text-anchor="middle" font-size="12" font-style="italic" fill="#3b82f6">«interface» Observer</text>
  <text x="178" y="168" font-size="10" fill="currentColor">update(): void</text>
  <!-- ConcreteObservers -->
  <rect x="30" y="215" width="130" height="40" rx="4" fill="none" stroke="#22c55e" stroke-width="1.5"/>
  <text x="95" y="230" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">ConcreteObs A</text>
  <text x="95" y="247" text-anchor="middle" font-size="10" fill="currentColor">update()</text>
  <rect x="200" y="215" width="130" height="40" rx="4" fill="none" stroke="#22c55e" stroke-width="1.5"/>
  <text x="265" y="230" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">ConcreteObs B</text>
  <text x="265" y="247" text-anchor="middle" font-size="10" fill="currentColor">update()</text>
  <rect x="370" y="215" width="110" height="40" rx="4" fill="none" stroke="#22c55e" stroke-width="1.5"/>
  <text x="425" y="230" text-anchor="middle" font-size="11" font-weight="bold" fill="#22c55e">ConcreteObs C</text>
  <text x="425" y="247" text-anchor="middle" font-size="10" fill="currentColor">update()</text>
  <!-- Subject → Observer (dashed notify) -->
  <line x1="250" y1="85" x2="250" y2="128" stroke="currentColor" stroke-width="1.5" stroke-dasharray="5,3" marker-end="url(#arr2)"/>
  <text x="260" y="112" font-size="9" fill="currentColor">notify()</text>
  <defs>
  ...
  <!-- Observer → ConcreteObs (inheritance open triangles) -->
  <line x1="95" y1="215" x2="215" y2="186" stroke="#3b82f6" stroke-width="1.2"/>
  <polygon points="215,186 205,198 225,198" fill="none" stroke="#3b82f6" stroke-width="1.2"/>
  <line x1="265" y1="215" x2="252" y2="186" stroke="#3b82f6" stroke-width="1.2"/>
  <polygon points="252,186 242,198 262,198" fill="none" stroke="#3b82f6" stroke-width="1.2"/>
  <line x1="425" y1="215" x2="292" y2="186" stroke="#3b82f6" stroke-width="1.2"/>
  <polygon points="292,186 282,198 302,198" fill="none" stroke="#3b82f6" stroke-width="1.2"/>
</svg>
...
See 26.3 of [CS 246E](https://pdf.sibeliusp.com/1189/cs246e.pdf) for an example of overloading and overriding.
...
See [isocpp](https://isocpp.org/wiki/faq/templates) or problem 10 & problem 24 of [CS 246E](https://pdf.sibeliusp.com/1189/cs246e.pdf).
...
# Exceptions
See problem 9 of [CS 246E](https://pdf.sibeliusp.com/1189/cs246e.pdf) for an introduction.
...
# Further topics
## smart pointers
[`unique_ptr`](https://en.cppreference.com/w/cpp/memory/unique_ptr) and [`shared_ptr`](https://en.cppreference.com/w/cpp/memory/shared_ptr) in `<memory>`. See problem 14 & 23 of [CS 246E](https://pdf.sibeliusp.com/1189/cs246e.pdf)
