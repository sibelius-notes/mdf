---
title: "CS 246EE: Object-Oriented Software Development — Modern C++ Extension"
subjects: "CS"
---

{{< lightning >}}
CS 246E works through thirty-four problems to build up the C++ object model from first principles — RAII, the Big Five, templates, iterators, and the visitor pattern. It necessarily stops at the boundary of modern C++: the language that emerged from C++11 onward is substantively different, and the idioms that govern it — move semantics, perfect forwarding, type erasure, concepts, ranges, and structured concurrency — are not extensions of what came before but new fluency. CS 246EE picks up where CS 246E leaves off with three movements: how *ownership and lifetime* are expressed cleanly through move semantics, `std::unique_ptr`, and RAII in the C++11/14/17 idiom; how *generic programming* reaches its full power through concepts, constexpr evaluation, and policy-based design; and how *concurrent C++* works from the memory model through atomics, futures, and coroutines. Stroustrup's flaneries (*A Tour of C++*), Meyers's *Effective Modern C++*, and Williams's *C++ Concurrency in Action* reach for adjacent ideas through their own lenses; CS 246EE is unapologetically problem-driven — the working C++ engineer's enrichment of CS 246E.
{{< /lightning >}}
...
> **Note:** CS 246EE extends CS 246E into modern C++ (C++11 through C++20). Content covered in the original CS 246E is not repeated here.
