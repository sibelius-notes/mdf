...
2. **Scena**: recitative setting the scene
3. **Tempo d'attacco** (opening movement): fast, kinetic — the plot moves forward
4. **Pezzo concertato** (or **Largo concertato**): slow, static — the concerted piece, where the characters react
5. **Tempo di mezzo** (middle movement): fast, kinetic, transitional, free in form
6. **Stretta** ("tightening"): fast, static conclusion
