...
- Ohio State: `PSYCH 7873` *Attitudes and Persuasion*.
- Queen's University: `PSYC 441` *Attitudes and Persuasion*.
- Stanford: `PWR 2AW` *Psychology and Persuasion*; GSB executive course *Persuasion: Principles and Practice*.
- Harvard Extension: *Psychology of Persuasion and Influence*.
- UCLA: `PSYCH 135` *Social Psychology* (attitudes module).
- University of Michigan: `PSYCH 353` *Social Psychology*, persuasion unit.
