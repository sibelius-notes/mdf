...
<svg viewBox="0 0 400 260" xmlns="http://www.w3.org/2000/svg" style="max-width:400px;display:block;margin:1.5em auto">
  ...
  <text x="200" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Parse Tree: ¬(p ∧ q) ∨ r</text>
  <!-- Root: ∨ -->
  <circle cx="200" cy="50" r="20" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="200" y="56" text-anchor="middle" font-size="14" fill="#3b82f6">∨</text>
  <!-- ¬ node -->
  <circle cx="120" cy="120" r="20" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="120" y="126" text-anchor="middle" font-size="14" fill="#3b82f6">¬</text>
  <!-- r leaf -->
  <circle cx="280" cy="120" r="20" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="280" y="126" text-anchor="middle" font-size="13" fill="#22c55e">r</text>
  <!-- ∧ node -->
  <circle cx="120" cy="195" r="20" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="120" y="201" text-anchor="middle" font-size="14" fill="#3b82f6">∧</text>
  <!-- p leaf -->
  <circle cx="60" cy="250" r="18" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="60" y="256" text-anchor="middle" font-size="13" fill="#22c55e">p</text>
  <!-- q leaf -->
  <circle cx="180" cy="250" r="18" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="180" y="256" text-anchor="middle" font-size="13" fill="#22c55e">q</text>
  <!-- Edges -->
  <line x1="184" y1="64" x2="136" y2="106" stroke="currentColor" stroke-width="1.5"/>
  <line x1="216" y1="64" x2="264" y2="106" stroke="currentColor" stroke-width="1.5"/>
  <line x1="120" y1="140" x2="120" y2="175" stroke="currentColor" stroke-width="1.5"/>
  <line x1="106" y1="207" x2="73" y2="238" stroke="currentColor" stroke-width="1.5"/>
  <line x1="134" y1="207" x2="167" y2="238" stroke="currentColor" stroke-width="1.5"/>
  <!-- Labels -->
  <text x="200" y="30" text-anchor="middle" font-size="9" fill="currentColor">evaluate bottom-up ↑</text>
</svg>
...
<svg viewBox="0 0 380 210" xmlns="http://www.w3.org/2000/svg" style="max-width:380px;display:block;margin:1.5em auto">
  <text x="190" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Truth Table: Implication α → β</text>
  <!-- Table header -->
  <rect x="20" y="25" width="340" height="28" fill="#3b82f6" fill-opacity="0.15"/>
  <text x="70" y="44" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">α</text>
  <text x="150" y="44" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">β</text>
  <text x="260" y="44" text-anchor="middle" font-size="12" font-weight="bold" fill="currentColor">α → β</text>
  <!-- Row 1 -->
  <rect x="20" y="53" width="340" height="30" fill="none" stroke="currentColor" stroke-width="0.5"/>
  <text x="70" y="73" text-anchor="middle" font-size="12" fill="currentColor">T</text>
  <text x="150" y="73" text-anchor="middle" font-size="12" fill="currentColor">T</text>
  <text x="260" y="73" text-anchor="middle" font-size="12" fill="#22c55e" font-weight="bold">T</text>
  <!-- Row 2 -->
  <rect x="20" y="83" width="340" height="30" fill="#ef4444" fill-opacity="0.1"/>
  <text x="70" y="103" text-anchor="middle" font-size="12" fill="currentColor">T</text>
  <text x="150" y="103" text-anchor="middle" font-size="12" fill="currentColor">F</text>
  <text x="260" y="103" text-anchor="middle" font-size="12" fill="#ef4444" font-weight="bold">F ← only false case</text>
  <!-- Row 3 -->
  <rect x="20" y="113" width="340" height="30" fill="none" stroke="currentColor" stroke-width="0.5"/>
  <text x="70" y="133" text-anchor="middle" font-size="12" fill="currentColor">F</text>
  <text x="150" y="133" text-anchor="middle" font-size="12" fill="currentColor">T</text>
  <text x="260" y="133" text-anchor="middle" font-size="12" fill="#22c55e" font-weight="bold">T</text>
  <!-- Row 4 -->
  <rect x="20" y="143" width="340" height="30" fill="none" stroke="currentColor" stroke-width="0.5"/>
  <text x="70" y="163" text-anchor="middle" font-size="12" fill="currentColor">F</text>
  <text x="150" y="163" text-anchor="middle" font-size="12" fill="currentColor">F</text>
  <text x="260" y="163" text-anchor="middle" font-size="12" fill="#22c55e" font-weight="bold">T (vacuously)</text>
  <!-- Note -->
  <text x="190" y="195" text-anchor="middle" font-size="10" fill="currentColor">α → β  ≡  ¬α ∨ β</text>
</svg>
...
<svg viewBox="0 0 420 260" xmlns="http://www.w3.org/2000/svg" style="max-width:420px;display:block;margin:1.5em auto">
  <text x="210" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Hilbert-Style Proof Derivation</text>
  <text x="210" y="32" text-anchor="middle" font-size="10" fill="currentColor">Goal: derive α → α from axioms and Modus Ponens</text>
  <!-- Step boxes -->
  <!-- Step 1 -->
  <rect x="10" y="45" width="400" height="28" rx="3" fill="#3b82f6" fill-opacity="0.08" stroke="currentColor" stroke-width="1"/>
  <text x="20" y="63" font-size="10" fill="currentColor">1. α → ((α → α) → α)</text>
  <text x="320" y="63" font-size="9" fill="#3b82f6">Axiom K</text>
  <!-- Step 2 -->
  <rect x="10" y="78" width="400" height="28" rx="3" fill="#3b82f6" fill-opacity="0.08" stroke="currentColor" stroke-width="1"/>
  <text x="20" y="96" font-size="10" fill="currentColor">2. (α → ((α → α) → α)) → ((α → (α → α)) → (α → α))</text>
  <text x="320" y="96" font-size="9" fill="#3b82f6">Axiom S</text>
  <!-- Step 3 -->
  <rect x="10" y="111" width="400" height="28" rx="3" fill="#22c55e" fill-opacity="0.10" stroke="currentColor" stroke-width="1"/>
  <text x="20" y="129" font-size="10" fill="currentColor">3. (α → (α → α)) → (α → α)</text>
  <text x="320" y="129" font-size="9" fill="#22c55e">MP: 1, 2</text>
  <!-- Step 4 -->
  <rect x="10" y="144" width="400" height="28" rx="3" fill="#3b82f6" fill-opacity="0.08" stroke="currentColor" stroke-width="1"/>
  <text x="20" y="162" font-size="10" fill="currentColor">4. α → (α → α)</text>
  <text x="320" y="162" font-size="9" fill="#3b82f6">Axiom K</text>
  <!-- Step 5 -->
  <rect x="10" y="177" width="400" height="28" rx="3" fill="#22c55e" fill-opacity="0.18" stroke="#22c55e" stroke-width="1.5"/>
  <text x="20" y="195" font-size="11" font-weight="bold" fill="#22c55e">5. α → α</text>
  <text x="320" y="195" font-size="9" fill="#22c55e">MP: 4, 3  ✓</text>
  <!-- Legend -->
  <text x="210" y="230" text-anchor="middle" font-size="9" fill="currentColor">MP (Modus Ponens): from α and α → β, conclude β</text>
  <text x="210" y="248" text-anchor="middle" font-size="9" fill="currentColor">Axiom K: α → (β → α)    Axiom S: (α→β→γ) → (α→β) → (α→γ)</text>
</svg>
...
<svg viewBox="0 0 480 200" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;display:block;margin:1.5em auto">
  <text x="240" y="16" text-anchor="middle" font-size="13" font-weight="bold" fill="currentColor">Predicate Logic: Quantifier Scope</text>
  <!-- Formula display -->
  <text x="240" y="50" text-anchor="middle" font-size="15" font-family="serif" fill="currentColor">∀x [ P(x, y) ∧ ∃y Q(x, y) ]</text>
  <!-- Scope bracket for ∀x -->
  <rect x="30" y="62" width="420" height="50" rx="4" fill="none" stroke="#3b82f6" stroke-width="2" stroke-dasharray="6,3"/>
  <text x="52" y="78" font-size="10" fill="#3b82f6">scope of ∀x</text>
  <!-- Scope bracket for ∃y -->
  <rect x="260" y="68" width="175" height="38" rx="4" fill="none" stroke="#ef4444" stroke-width="2" stroke-dasharray="4,2"/>
  <text x="270" y="82" font-size="10" fill="#ef4444">scope of ∃y</text>
  <!-- Variable labels below -->
  <text x="175" y="135" text-anchor="middle" font-size="11" fill="#3b82f6">x: bound (by ∀x)</text>
  <text x="175" y="152" text-anchor="middle" font-size="11" fill="#ef4444">y: FREE here</text>
  <text x="370" y="135" text-anchor="middle" font-size="11" fill="#3b82f6">x: bound (by ∀x)</text>
  <text x="370" y="152" text-anchor="middle" font-size="11" fill="#ef4444">y: bound (by ∃y)</text>
  <!-- Arrows pointing to occurrences -->
  <line x1="145" y1="43" x2="145" y2="128" stroke="#ef4444" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="380" y1="43" x2="380" y2="128" stroke="#ef4444" stroke-width="1" stroke-dasharray="3,2"/>
  <!-- Note -->
  <text x="240" y="183" text-anchor="middle" font-size="9" fill="currentColor">A formula with free variables has no definite truth value without an assignment.</text>
</svg>
