...
**Economics** is the social science that studies the choices individuals, businesses, governments, and entire societies make as they cope with scarcity, and the incentives that influence and reconcile those choices. This definition contains three foundational concepts that recur throughout the discipline: **scarcity**, **choice**, and **incentives**.

**Scarcity** arises because human wants are unlimited while the resources available to satisfy those wants are finite. Everyone faces scarcity in some form: individuals are constrained by time, income, and wealth; businesses are constrained by suppliers, demand, and regulation; governments are constrained by budgets and demographics. Scarcity is always relative — it is the gap between unlimited wants and limited resources.

Because we cannot satisfy all wants simultaneously, we must make **choices** among alternatives. Every choice involves a **trade-off**: selecting one option means forgoing another. **Incentives** — rewards or penalties that influence a rational actor's decisions — shape which choices people make. Positive incentives (scholarships, profit) attract behaviour; negative incentives (fines, penalties) discourage it. Rational individuals respond predictably to incentives by gravitating toward options with greater net benefit.

Economics is a **social science** — it is not merely about money. It uses the scientific method to study human behaviour under conditions of scarcity. This involves distinguishing between two types of statements:

- **Positive statements** describe "what is" — they are testable and tend to command broad agreement among economists (e.g., "Raising cigarette taxes increases cigarette prices and reduces smoking.").
- **Normative statements** express "what ought to be" — they are value judgments, not directly testable, and economists often disagree on them (e.g., "Cigarette taxes should be raised.").

To test positive statements, economists build **economic models** — abstract, simplified representations of the real world. A good model need not be realistic in appearance; it must predict well. Models are tested through natural experiments (observing real-world events like the stagflation of the 1970s), statistical investigation (regression analysis), and controlled economic experiments.

The field divides into two branches: **microeconomics**, the focus of this course, studies individual economic units — consumers, firms, and specific markets. **Macroeconomics** studies the economy at the aggregate level — sectors, national output, unemployment, and inflation.

## 1.2 Economic Questions

Two fundamental questions organize economic inquiry:

**1. How do choices end up determining what, how, and for whom goods and services are produced?**

Goods and services — the items people consume to satisfy wants — are produced using **factors of production**: land (natural resources), labour (workers' time and effort), capital (physical machinery and human capital such as skills and education), and entrepreneurship (the organizational force that combines the other factors). The factor payments are, respectively: rent, wages, interest, and profit. These factor payments also determine *for whom* output is ultimately distributed.

**2. How can choices made in the pursuit of self-interest also promote the social interest?**

Individual self-interest and social interest are often thought to conflict, yet economics explores how they can align. A student who pursues higher education for personal gain also benefits society through a larger tax base, higher productivity, and improved civic participation. This duality — self-interest producing socially beneficial outcomes — is a central concern of microeconomics.

## 1.3 The Economic Way of Thinking

Economic reasoning centres on five themes related to choice:

**Choice and trade-offs.** Every choice is a trade-off between alternatives. The classic macroeconomic trade-off is *efficiency versus equity*: efficiency is about maximizing the size of the "economic pie," while equity concerns how the pie is divided. Taxing the wealthy to redistribute income to the poor can increase equity but may reduce efficiency by diminishing work incentives, shrinking the pie while sharing it more equally.
...
**Choice and incentives.** Changes in marginal benefit or marginal cost alter incentives and therefore alter behaviour. Economists use this principle to predict responses to policy changes, price shifts, and regulatory changes.

## 1.4 Economic Coordination

How does a complex decentralized economy coordinate the decisions of millions of producers and consumers? The answer lies in the **Circular Flow in the Market Economy** — a model depicting how households and firms interact through two sets of markets.

A **firm** hires factors of production and organizes them to produce goods and services for sale. A **household** supplies factors of production to firms and uses the resulting income to purchase goods and services. A **market** is any arrangement enabling buyers and sellers to exchange information and transact.

In the circular flow: households supply land, labour, capital, and entrepreneurship to the **factor markets**, receiving rent, wages, interest, and profit in return. They then spend this income purchasing goods and services in the **goods market**, where firms sell their output. **Prices** coordinate these decisions — rising prices signal scarcity and attract resources; falling prices signal surplus and redirect resources elsewhere.

The model is a simplification. It omits government (taxes, spending, regulation) and international trade, topics developed later. Despite these omissions, it provides a fundamental picture of how a decentralized market system self-organizes through price signals — an idea Adam Smith famously called the **"invisible hand."**

## 1.5 The Production Possibility Frontier

The **Production Possibility Frontier (PPF)** is a graphical model showing all combinations of two goods that an economy can produce given its available factors of production and technology. Points *on* the PPF are **productively efficient** — all resources are fully employed. Points *inside* the PPF are **inefficient** (resources are underutilized or misallocated). Points *outside* the PPF are **unattainable** given current resources and technology.

The PPF illustrates opportunity cost directly. Moving from point B (500 guns, 200 butter) to point C (350 guns, 400 butter) on a typical PPF, the economy sacrifices 150 guns to obtain 200 additional units of butter:

\[
\text{Opportunity Cost} = \frac{\text{What we give up}}{\text{What we get}} = \frac{150 \text{ guns}}{200 \text{ butter}} = 0.75 \text{ guns per unit of butter}
\]

The PPF is **bowed outward** because resources are not perfectly interchangeable — some workers are better at producing guns, others at churning butter. As more butter is produced, increasingly unsuitable resources are diverted toward butter production, raising the opportunity cost. This illustrates the **law of increasing opportunity cost**. A linear PPF would imply a constant opportunity cost and perfectly homogeneous resources, which is unrealistic.

**Allocative efficiency** — producing the combination that best serves society — requires finding the point where the **marginal benefit (MB) curve** intersects the **marginal cost (MC) curve**. Marginal cost (the slope of the PPF at each point) rises as more of a good is produced. Marginal benefit (the maximum willingness to pay) declines as more is consumed. The efficient quantity is where \(MB = MC\).

The PPF can shift outward over time through **technological advancement** (which lowers the cost of production) or **capital accumulation** (investing more in machinery and infrastructure). The opportunity cost of economic growth is reduced *current* consumption — producing more ovens (capital goods) today means fewer cookies (consumption goods) today, but more cookies tomorrow. Hong Kong's rapid outward shift of its PPF relative to Canada between 1963 and the early 2000s illustrates this: by investing heavily in capital goods, Hong Kong achieved faster long-run growth.

## 1.6 Specialization and Trade

**Comparative advantage** is the organizing principle of specialization and trade. A person (or country) has a **comparative advantage** in an activity if they can perform it at a *lower opportunity cost* than others. An **absolute advantage** means being more productive in absolute terms — producing more output per unit of input.

Crucially, a person or country can have an absolute advantage in *every* activity, but cannot have a comparative advantage in every activity simultaneously — because opportunity costs are relative.

Consider the example from the course: Corey can wash 30 dishes per hour or complete 30 Zelda tasks per hour, so his opportunity cost of one task in Zelda is 1 dish (\(OC^C_{Zelda} = 1 \text{ dish}\)). Mona can wash 30 dishes per hour or complete only 6 Zelda tasks per hour, so her opportunity cost of one dish is \(\frac{1}{5}\) of a Zelda task (\(OC^M_{Dish} = \frac{1}{5} \text{ Zelda}\)). Corey has an absolute advantage in Zelda (and ties in dishes). Corey has a comparative advantage in Zelda (opportunity cost 1 dish < Mona's 5 dishes); Mona has a comparative advantage in washing dishes (opportunity cost \(\frac{1}{5}\) Zelda task < Corey's 1 Zelda task).

When each specializes according to comparative advantage and trades, *both* parties can consume beyond their individual PPFs. In the example, after specialization and trade, both Corey and Mona gain 5 Zelda tasks and 5 clean dishes per hour compared to before. The gains from trade arise from differences in opportunity costs, not from absolute productivity differences. This principle applies equally to nations: every country benefits from trading according to its comparative advantage, even if one country is more productive in every industry.
...
A **market** is any arrangement enabling buyers and sellers to exchange information and transact. A **competitive market** has so many buyers and sellers that no single participant can influence the price. The **money price** is the dollar amount; the **relative price** — the ratio of one good's price to another's — is the opportunity cost.

Before you *demand* something, three conditions must hold: you must want it, be able to afford it, and have made a definite plan to buy it. **Quantity demanded** is the amount consumers plan to buy at a given price during a given period.

The **law of demand** states that, *ceteris paribus* (all else equal), the higher the price of a good, the smaller the quantity demanded, and vice versa. This inverse relationship arises from two effects:

- **Substitution effect**: When the relative price of a good rises, consumers shift toward cheaper substitutes. Higher sports-drink prices push consumers toward bottled water.
- **Income effect**: When the price of a good rises, purchasing power effectively falls. Consumers can no longer afford the same bundle, so they buy less of the more expensive good (for normal goods).

The **demand curve** shows the entire relationship between price and quantity demanded, holding all other influences constant. It slopes downward. A **demand schedule** tabulates price-quantity combinations. Moving along the curve — called a **change in quantity demanded** — is caused solely by a price change.

A **change in demand** shifts the entire curve, caused by changes in factors *other than the price of the good itself*:

1. **Prices of related goods**: A rise in the price of a substitute (e.g., Pepsi) increases demand for the good (e.g., Coke). A rise in the price of a complement (e.g., coffee filters) decreases demand for the complement good (e.g., coffee).
2. **Expected future prices**: If consumers expect prices to rise, demand increases today.
3. **Income**: For a **normal good**, demand rises when income rises. For an **inferior good**, demand falls when income rises.
4. **Population**: More potential buyers increases demand.
5. **Preferences**: Changes in tastes shift demand.

## 2.2 Supply

Before a firm *supplies* a good, three conditions must hold: it must have the resources and technology to produce it, be able to earn a profit, and have made a definite plan to produce and sell it. **Quantity supplied** is the amount producers plan to sell at a given price during a given period.

The **law of supply** states that, *ceteris paribus*, the higher the price of a good, the greater the quantity supplied. The positive relationship arises because a higher price covers the higher **marginal cost** that accompanies increased production. A firm's supply curve is its marginal cost curve — it shows the minimum price at which a producer is willing to sell each successive unit.

A **change in quantity supplied** is movement along the supply curve in response to a price change. A **change in supply** shifts the entire curve, caused by:

1. **Prices of factors of production**: Higher input costs (wages, materials) reduce supply (shift left).
2. **Prices of related goods produced**: Higher prices for a substitute-in-production attract resources away, decreasing supply of the original good. Higher prices for a complement-in-production increase supply of both goods.
3. **Expected future prices**: If producers expect prices to rise, they withhold supply today (shift left).
4. **Number of suppliers**: More suppliers increase supply (shift right).
5. **Technology**: Better technology lowers costs and increases supply (shift right).
6. **State of nature**: Favourable natural conditions increase agricultural supply; disasters decrease it.

## 2.3 Market Equilibrium

The **market equilibrium price** is the price at which quantity demanded equals quantity supplied — the point where the demand and supply curves intersect. At the **market equilibrium quantity**, every consumer who wants to buy at that price can, and every producer who wants to sell can.

If the market price is above equilibrium, a **surplus** (excess supply) exists: producers have unsold inventory and cut prices to clear it. If the price is below equilibrium, a **shortage** (excess demand) exists: consumers cannot buy all they want, and producers raise prices. In both cases, **market forces drive the price toward equilibrium** — illustrating Adam Smith's "invisible hand."

Mathematically, demand and supply can be expressed as linear equations. Setting \(Q_D = Q_S\) solves for the equilibrium price \(P^*\), from which equilibrium quantity \(Q^*\) follows.

## 2.4 Predicting Changes in Price and Quantity

Using the supply-demand model, we can predict how equilibrium price and quantity change when demand or supply shifts:

| Change | Effect on Price | Effect on Quantity |
|---|---|---|
| Increase in demand only | Rises | Rises |
| Decrease in demand only | Falls | Falls |
| Increase in supply only | Falls | Rises |
| Decrease in supply only | Rises | Falls |

When *both* curves shift simultaneously, the result depends on the relative magnitudes of the shifts. For example, if demand increases and supply decreases by the same amount, price rises but quantity is unchanged. If both increase proportionally, quantity rises but price is unchanged. When the shifts are not proportional, one effect dominates, making both price and quantity change — but one direction is ambiguous without knowing the relative magnitudes.
...
The slope of a demand curve tells us the direction of the price-quantity relationship but not its intensity. **Price elasticity of demand** (\(\varepsilon_D\)) is a units-free measure of how responsive quantity demanded is to a price change:

\[
\varepsilon_D = \frac{\Delta Q / \text{avg } Q}{\Delta P / \text{avg } P} = \frac{(Q_{new} - Q_{old})/[(Q_{new}+Q_{old})/2]}{(P_{new} - P_{old})/[(P_{new}+P_{old})/2]}
\]

Using average values (the midpoint method) ensures the elasticity is the same regardless of the direction of the price change. Because of the law of demand, \(\varepsilon_D\) is always negative; economists typically report its absolute value.

**Ranges of elasticity:**

- **Perfectly inelastic** (\(|\varepsilon_D| = 0\)): Demand curve is vertical; quantity does not change regardless of price (e.g., life-saving medication with no substitute).
- **Inelastic** (\(0 < |\varepsilon_D| < 1\)): Quantity changes proportionally less than price.
- **Unit elastic** (\(|\varepsilon_D| = 1\)): Quantity and price change by the same percentage.
- **Elastic** (\(1 < |\varepsilon_D| < \infty\)): Quantity changes proportionally more than price.
- **Perfectly elastic** (\(|\varepsilon_D| = \infty\)): Demand curve is horizontal; the slightest price increase drives quantity to zero (e.g., a competitive firm's demand curve).

Along a linear demand curve, demand is elastic in the upper half (above the midpoint), unit elastic at the midpoint, and inelastic in the lower half. The elasticity changes continuously along the curve.

**Factors affecting price elasticity of demand:**
- **Closeness of substitutes**: More substitutes → more elastic. Necessities (food, housing) tend to be inelastic; luxuries tend to be elastic.
- **Proportion of income spent**: Goods that take a large share of the budget tend to have more elastic demand.
- **Time elapsed**: Consumers adjust more fully over longer time horizons, making long-run demand more elastic than short-run demand.

**Elasticity, total revenue, and the total revenue test:**

<div class="definition"><strong>Total revenue (TR) = Price × Quantity.</strong> When price changes, the effect on TR depends on elasticity.</div>

- Elastic demand: A price cut increases TR (quantity rises more than proportionally).
...
# Chapter 4: Resource Allocation, Surplus, and Efficiency

## 4.1 Resource Allocation Methods
...
When multiple consumers participate, the market demand curve is the horizontal sum of individual demand curves. Consumer surplus measures the net gain to buyers from market participation. Policies that lower prices (like rent ceilings) might appear to benefit consumers but can actually shrink total consumer surplus by reducing the quantity available.
...
Producer surplus measures the net gain to sellers from market participation.
...
<div class="definition"><strong>Tax incidence:</strong> the division of the tax burden between buyers and sellers — who actually bears the economic cost of the tax, regardless of who legally remits it.</div>
...
# Chapter 6: Consumer Theory — Utility Maximization
...
If \(\frac{MU_M}{P_M} > \frac{MU_P}{P_P}\), the consumer gets more satisfaction per dollar from movies than pop and should shift spending toward movies until equality is restored. This is an application of marginal analysis: the consumer continues adjusting until no reallocation can raise total utility.

In the course example, Lisa's utility is maximized when she sees 2 movies and buys 6 cases of pop, where \(\frac{MU_M}{P_M} = \frac{40}{8} = 5 = \frac{MU_P}{P_P} = \frac{20}{4}\). This gives a total utility of 315 units.

## 6.3 Predictions of Marginal Utility Theory
...
# Chapter 7: Consumer Theory — Indifference Curves

## 7.1 Consumption Possibilities and the Budget Equation

The budget line can be expressed as a formal equation. With income \(M\), price of pop \(P_P\), and price of movies \(P_M\):
...
# Chapter 8: The Firm — Costs and Organization
...
- Free entry and exit
- No collusion (coordination among many firms is impractical)
...
In the duopoly price-fixing game (Switchies and Gearbox), the payoff matrix (in millions per week) is:
