...
Also available: [Winter 2020 notes](/1201/cs350) and [Winter 2020 help page](/1201/cs350help).
...
<svg viewBox="0 0 500 260" xmlns="http://www.w3.org/2000/svg" style="max-width:500px;display:block;margin:1.5em auto">
  <defs>
    <marker id="arr350ps" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="currentColor"/>
    </marker>
  </defs>
  <!-- New -->
  <rect x="10" y="110" width="70" height="34" rx="8" fill="none" stroke="#888" stroke-width="1.5"/>
  <text x="45" y="132" text-anchor="middle" font-size="12">New</text>
  <!-- Ready -->
  <circle cx="200" cy="80" r="34" fill="none" stroke="#3b82f6" stroke-width="2"/>
  <text x="200" y="85" text-anchor="middle" font-size="13" fill="#3b82f6" font-weight="bold">Ready</text>
  <!-- Running -->
  <circle cx="310" cy="130" r="34" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="310" y="135" text-anchor="middle" font-size="13" fill="#22c55e" font-weight="bold">Running</text>
  <!-- Blocked -->
  <circle cx="200" cy="200" r="34" fill="none" stroke="#f97316" stroke-width="2"/>
  <text x="200" y="205" text-anchor="middle" font-size="13" fill="#f97316" font-weight="bold">Blocked</text>
  <!-- Terminated -->
  <rect x="400" y="113" width="90" height="34" rx="8" fill="none" stroke="#ef4444" stroke-width="1.5"/>
  <text x="445" y="135" text-anchor="middle" font-size="12" fill="#ef4444">Terminated</text>
  <!-- Arrows -->
  <!-- New → Ready -->
  <line x1="80" y1="122" x2="165" y2="90" stroke="#888" stroke-width="1.5" marker-end="url(#arr350ps)"/>
  <text x="108" y="100" font-size="9" fill="#888">admit</text>
  <!-- Ready → Running (dispatch) -->
  <path d="M230,96 C260,96 278,110 278,126" fill="none" stroke="#22c55e" stroke-width="1.5" marker-end="url(#arr350ps)"/>
  <text x="272" y="103" font-size="9" fill="#22c55e">dispatch</text>
  <!-- Running → Ready (preempt) -->
  <path d="M278,134 C258,134 240,110 230,98" fill="none" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#arr350ps)"/>
  <text x="228" y="132" font-size="9" fill="#3b82f6">preempt/yield</text>
  <!-- Running → Blocked -->
  <path d="M296,160 C280,190 248,200 234,204" fill="none" stroke="#f97316" stroke-width="1.5" marker-end="url(#arr350ps)"/>
  <text x="248" y="193" font-size="9" fill="#f97316">I/O wait / block</text>
  <!-- Blocked → Ready (unblock) -->
  <path d="M168,192 C145,185 165,100 168,94" fill="none" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#arr350ps)"/>
  <text x="115" y="145" font-size="9" fill="#3b82f6">unblock</text>
  <!-- Running → Terminated (exit) -->
  <line x1="344" y1="130" x2="398" y2="130" stroke="#ef4444" stroke-width="1.5" marker-end="url(#arr350ps)"/>
  <text x="370" y="122" font-size="9" fill="#ef4444">exit</text>
</svg>
...
<svg viewBox="0 0 480 200" xmlns="http://www.w3.org/2000/svg" style="max-width:480px;display:block;margin:1.5em auto">
  <defs>
    <marker id="arr350sem" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
      <path d="M0,0 L0,6 L7,3 z" fill="currentColor"/>
    </marker>
  </defs>
  <!-- Thread A -->
  <rect x="20" y="20" width="120" height="160" rx="6" fill="#3b82f620" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="80" y="38" text-anchor="middle" font-size="12" fill="#3b82f6" font-weight="bold">Thread A</text>
  <rect x="35" y="48" width="90" height="20" rx="3" fill="none" stroke="#3b82f6" stroke-width="1"/>
  <text x="80" y="62" text-anchor="middle" font-size="10">lock_acquire()</text>
  <rect x="35" y="75" width="90" height="30" rx="3" fill="#3b82f630" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="80" y="93" text-anchor="middle" font-size="10" fill="#3b82f6">critical</text>
  <text x="80" y="106" text-anchor="middle" font-size="10" fill="#3b82f6">section</text>
  <rect x="35" y="112" width="90" height="20" rx="3" fill="none" stroke="#3b82f6" stroke-width="1"/>
  <text x="80" y="126" text-anchor="middle" font-size="10">lock_release()</text>
  <!-- Mutex -->
  <rect x="190" y="70" width="100" height="50" rx="8" fill="#f9731620" stroke="#f97316" stroke-width="2"/>
  <text x="240" y="91" text-anchor="middle" font-size="12" font-weight="bold" fill="#f97316">MUTEX</text>
  <text x="240" y="108" text-anchor="middle" font-size="11" fill="#f97316">count=1</text>
  <!-- Thread B -->
  <rect x="340" y="20" width="120" height="160" rx="6" fill="#22c55e20" stroke="#22c55e" stroke-width="1.5"/>
  <text x="400" y="38" text-anchor="middle" font-size="12" fill="#22c55e" font-weight="bold">Thread B</text>
  <rect x="355" y="48" width="90" height="20" rx="3" fill="none" stroke="#22c55e" stroke-width="1"/>
  <text x="400" y="62" text-anchor="middle" font-size="10">lock_acquire()</text>
  <rect x="355" y="75" width="90" height="30" rx="3" fill="#88888830" stroke="#888" stroke-width="1.5" stroke-dasharray="4,3"/>
  <text x="400" y="93" text-anchor="middle" font-size="10" fill="#888">waiting...</text>
  <text x="400" y="106" text-anchor="middle" font-size="9" fill="#888">(blocked)</text>
  <rect x="355" y="112" width="90" height="20" rx="3" fill="none" stroke="#22c55e" stroke-width="0.5" opacity="0.4"/>
  <text x="400" y="126" text-anchor="middle" font-size="10" opacity="0.4">lock_release()</text>
  <!-- Arrows A <-> mutex -->
  <path d="M125,85 L187,88" fill="none" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#arr350sem)"/>
  <text x="155" y="80" font-size="9" fill="#3b82f6">P()</text>
  <path d="M187,108 L125,108" fill="none" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#arr350sem)"/>
  <text x="155" y="120" font-size="9" fill="#3b82f6">V()</text>
  <!-- Arrow B -> mutex (blocked) -->
  <path d="M353,85 L293,88" fill="none" stroke="#888" stroke-width="1.5" stroke-dasharray="4,3" marker-end="url(#arr350sem)"/>
  <text x="320" y="78" font-size="9" fill="#888">P() blocked</text>
  <!-- Note -->
  <text x="240" y="175" text-anchor="middle" font-size="10" fill="#888">B waits until A calls V() (release)</text>
</svg>
...
<svg viewBox="0 0 260 340" xmlns="http://www.w3.org/2000/svg" style="max-width:260px;display:block;margin:1.5em auto">
  <!-- Memory segments (low addr at bottom) -->
  <!-- Text segment -->
  <rect x="60" y="270" width="140" height="40" fill="#3b82f620" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="130" y="295" text-anchor="middle" font-size="12" fill="#3b82f6" font-weight="bold">Text (code)</text>
  <!-- Data -->
  <rect x="60" y="228" width="140" height="40" fill="#22c55e20" stroke="#22c55e" stroke-width="1.5"/>
  <text x="130" y="253" text-anchor="middle" font-size="12" fill="#22c55e" font-weight="bold">Data (globals)</text>
  <!-- BSS -->
  <rect x="60" y="186" width="140" height="40" fill="#22c55e15" stroke="#22c55e" stroke-width="1" stroke-dasharray="4,3"/>
  <text x="130" y="211" text-anchor="middle" font-size="12" fill="#22c55e">BSS (uninit)</text>
  <!-- Heap -->
  <rect x="60" y="130" width="140" height="54" fill="#f9731620" stroke="#f97316" stroke-width="1.5"/>
  <text x="130" y="155" text-anchor="middle" font-size="12" fill="#f97316" font-weight="bold">Heap</text>
  <text x="130" y="172" text-anchor="middle" font-size="11" fill="#f97316">↓ grows down ↓</text>
  <!-- Gap -->
  <rect x="60" y="100" width="140" height="28" fill="none" stroke="#ccc" stroke-width="1" stroke-dasharray="2,2"/>
  <text x="130" y="119" text-anchor="middle" font-size="10" fill="#ccc">unmapped</text>
  <!-- Stack -->
  <rect x="60" y="40" width="140" height="58" fill="#ef444420" stroke="#ef4444" stroke-width="1.5"/>
  <text x="130" y="64" text-anchor="middle" font-size="12" fill="#ef4444" font-weight="bold">Stack</text>
  <text x="130" y="82" text-anchor="middle" font-size="11" fill="#ef4444">↑ grows up ↑</text>
  <!-- High addr label -->
  <text x="130" y="26" text-anchor="middle" font-size="10" fill="#888">High address (0xFFFF…)</text>
  <line x1="60" y1="30" x2="200" y2="30" stroke="#888" stroke-width="0.5"/>
  <!-- Low addr label -->
  <text x="130" y="325" text-anchor="middle" font-size="10" fill="#888">Low address (0x0000)</text>
  <!-- Address axis -->
  <line x1="20" y1="40" x2="20" y2="308" stroke="#888" stroke-width="1"/>
  <text x="12" y="175" font-size="9" fill="#888" transform="rotate(-90,12,175)">Virtual Address</text>
</svg>
...
<svg viewBox="0 0 520 160" xmlns="http://www.w3.org/2000/svg" style="max-width:520px;display:block;margin:1.5em auto">
  <defs>
    <marker id="arr350pt" markerWidth="7" markerHeight="7" refX="5" refY="3" orient="auto">
      <path d="M0,0 L0,6 L7,3 z" fill="currentColor"/>
    </marker>
  </defs>
  <!-- Virtual address -->
  <text x="10" y="18" font-size="11" font-weight="bold">Virtual Address (32-bit):</text>
  <rect x="10" y="26" width="110" height="26" fill="#3b82f620" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="65" y="44" text-anchor="middle" font-size="11" fill="#3b82f6">Page # (20 bits)</text>
  <rect x="120" y="26" width="80" height="26" fill="#22c55e20" stroke="#22c55e" stroke-width="1.5"/>
  <text x="160" y="44" text-anchor="middle" font-size="11" fill="#22c55e">Offset (12 bits)</text>
  <!-- Arrow down to page table -->
  <line x1="65" y1="52" x2="65" y2="75" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#arr350pt)"/>
  <!-- Page table -->
  <text x="20" y="90" font-size="10" fill="#888">Page Table:</text>
  <rect x="10" y="96" width="50" height="22" fill="none" stroke="#888" stroke-width="1"/>
  <text x="35" y="111" text-anchor="middle" font-size="9">page 0</text>
  <rect x="60" y="96" width="50" height="22" fill="#3b82f630" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="85" y="111" text-anchor="middle" font-size="9" fill="#3b82f6">frame 7</text>
  <rect x="110" y="96" width="50" height="22" fill="none" stroke="#888" stroke-width="1"/>
  <text x="135" y="111" text-anchor="middle" font-size="9">page 2</text>
  <text x="170" y="111" font-size="10" fill="#888">…</text>
  <!-- Arrow from page table to physical -->
  <line x1="200" y1="107" x2="240" y2="107" stroke="#3b82f6" stroke-width="1.5" marker-end="url(#arr350pt)"/>
  <text x="218" y="100" font-size="9" fill="#3b82f6">lookup</text>
  <!-- Physical address construction -->
  <text x="245" y="18" font-size="11" font-weight="bold">Physical Address:</text>
  <rect x="245" y="26" width="110" height="26" fill="#3b82f630" stroke="#3b82f6" stroke-width="1.5"/>
  <text x="300" y="44" text-anchor="middle" font-size="11" fill="#3b82f6">Frame # (20 bits)</text>
  <rect x="355" y="26" width="80" height="26" fill="#22c55e20" stroke="#22c55e" stroke-width="1.5"/>
  <text x="395" y="44" text-anchor="middle" font-size="11" fill="#22c55e">Offset (12 bits)</text>
  <!-- connect frame# from lookup -->
  <line x1="242" y1="107" x2="300" y2="52" stroke="#3b82f6" stroke-width="1.5" stroke-dasharray="4,3" marker-end="url(#arr350pt)"/>
  <!-- Offset pass-through -->
  <path d="M160,39 C200,39 210,39 245,39" fill="none" stroke="#22c55e" stroke-width="1" stroke-dasharray="3,3" marker-end="url(#arr350pt)"/>
  <text x="202" y="35" font-size="9" fill="#22c55e">offset unchanged</text>
  <!-- Physical memory box -->
  <rect x="450" y="80" width="60" height="70" fill="none" stroke="#888" stroke-width="1.5"/>
  <text x="480" y="98" text-anchor="middle" font-size="9">Physical</text>
  <text x="480" y="110" text-anchor="middle" font-size="9">Memory</text>
  <rect x="452" y="116" width="56" height="14" fill="#3b82f620" stroke="#3b82f6" stroke-width="1"/>
  <text x="480" y="127" text-anchor="middle" font-size="8" fill="#3b82f6">frame 7</text>
  <line x1="435" y1="39" x2="480" y2="116" stroke="#888" stroke-width="1.5" marker-end="url(#arr350pt)"/>
  <text x="460" y="75" font-size="9" fill="#888">→ access</text>
  <!-- Note -->
  <text x="260" y="150" text-anchor="middle" font-size="10" fill="#888">4 KB pages: offset = low 12 bits; page# = high 20 bits</text>
</svg>
...
![Scheduling Gantt Chart](/pics/cs350_1215/scheduling_gantt.png)
...
![SCAN Disk Scheduling](/pics/cs350_1215/disk_scheduling.png)
...
Unix systems combine multiple file systems into a single namespace using `mount`. Windows uses drive letters such as `C:\` and `D:\`.
