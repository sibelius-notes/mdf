...
<div class="definition"><strong>Personal Finance:</strong> The process of planning your spending, financing, and investing activities, while taking into account uncontrollable events such as death or disability, in order to optimize your financial situation over time.</div>
...
<div class="definition"><strong>Net Worth:</strong> The value of what you own minus the value of what you owe (Assets − Liabilities).</div>
...
<div class="definition"><strong>Liquidity:</strong> Your access to ready cash — including savings and credit — to cover short-term or unexpected expenses.</div>
...
<div class="definition"><strong>Risk:</strong> Exposure to events (or perils) that can cause a financial loss.</div>
<div class="definition"><strong>Risk Management:</strong> Decisions about whether and how to protect against risk.</div>
<div class="definition"><strong>Insurance Planning:</strong> Determining the types and amount of insurance needed to protect your assets and/or income.</div>
...
<div class="definition"><strong>Investment Risk:</strong> The uncertainty surrounding the potential return on an investment and its future potential value.</div>
<div class="definition"><strong>Risk Tolerance:</strong> Your ability to accept potential losses of return and/or capital.</div>
...
<div class="definition"><strong>Retirement Planning:</strong> Determining how much money should be set aside each year for retirement and how those funds should be invested.</div>
<div class="definition"><strong>Estate Planning:</strong> Determining how your wealth will be distributed before and/or after your death.</div>
...
The course was delivered remotely via **MS Teams** in Spring 2021, with synchronous video sessions held Monday, Wednesday, and Friday from 10:00 to 10:50 AM EST. Sessions were recorded for asynchronous access. Instructor Predrag Rajsic holds a PhD from the University of Guelph and researches the relationship between property rights, markets, and business performance.

## Course Description and Goals

MGMT 171 focuses on budgeting, saving, and investment decisions of individuals and small businesses. It addresses practical questions that arise in everyday financial life: How do student loans work? Should you buy or rent a house? Should you buy or lease a car? What is the difference between mutual funds and individual stocks or bonds? How do you secure a safe retirement? How do you insure your assets, income, and health?

By the end of the course, students are expected to be able to:

- Understand why individuals must make financial decisions and how scarcity shapes those choices.
- Assess, manage, and secure credit appropriately.
- Analyze the financial aspects of purchasing and financing a home.
- Make informed choices about auto and homeowner's insurance.
- Understand the basic principles of investing in stocks, bonds, and mutual funds.
- Develop a basic retirement plan.

## The "Pay Yourself First" Principle

A central theme of the course is the **pay yourself first** principle: before paying expenses or making discretionary purchases, you commit a portion of your income directly to savings or investment. This principle counteracts the psychological tendency to spend first and save whatever is left over — which typically results in saving very little.

## Course Schedule and Topics

The course follows the textbook's five-part structure across 14 weeks:

| Week | Topics | Textbook |
|------|---------|----------|
| 1 | Course Orientation; Overview of a Financial Plan | Ch 1 |
| 2 | Applying Time Value Concepts | Ch 2 |
| 3 | Planning with Personal Financial Statements | Ch 3 |
| 4 | Banking Services and Managing Your Money | Ch 5 |
| 5 | Assessing, Managing, and Securing Your Credit | Ch 6 |
| 6 | Purchasing and Financing a Home | Ch 7 |
| 7 | Midterm 1 Review; Auto and Homeowner's Insurance | Ch 8 |
| 8–9 | Auto and Homeowner's Insurance; Health and Life Insurance | Ch 8, 9 |
| 10 | Health and Life Insurance; Investing Fundamentals | Ch 9, 10 |
| 11 | Investing Fundamentals | Ch 10 |
| 12 | Midterm 2 Review; Retirement Planning | Ch 14 |
| 13 | Retirement Planning; Integrating the Components | Ch 14, 16 |
| 14 | Integrating the Components; Final Exam Review | Ch 16 |

## Assessment

The course grade is composed of review quizzes (5%), two midterms (the higher-scoring midterm counts 25% and the lower 20%), two assignments (12.5% each), and a final paper — a financial plan for a hypothetical person or family (25%). The final paper integrates all five components of the course into a coherent, realistic, and well-written financial plan.

### Review Quizzes

Six quizzes are administered online through LEARN, each consisting of 10 multiple-choice, true-false, or short-answer questions, with two attempts allowed (better result recorded) and a 120-minute limit. Quizzes not submitted on time receive zero.

### Assignments

Two assignments combine word-answer essay-style questions with numerical problems. Each student receives a unique set of numerical values for the quantitative portions, ensuring individualized solutions. Assignments are submitted via the LEARN Dropbox.

### Final Paper: Financial Plan

The capstone of the course is a complete financial plan for a hypothetical individual or family. Students choose the demographic, life circumstances, constraints, and goals of their subject. The plan is graded on realism, complexity, appropriate application of course concepts, and writing quality (grammar, clarity, style, ease of reading).

---

# Key Definitions Reference

<div class="definition"><strong>Personal Finance:</strong> The process of planning spending, financing, and investing to optimize one's financial situation over time, including management of risk from uncontrollable events.</div>

<div class="definition"><strong>Opportunity Cost:</strong> What you give up as a result of a decision; the value of the next-best alternative foregone.</div>

<div class="definition"><strong>Net Worth:</strong> Total assets minus total liabilities; the fundamental measure of personal financial position.</div>

<div class="definition"><strong>Liquidity:</strong> Access to ready cash — including savings and credit — to meet short-term or unexpected needs without incurring significant losses.</div>

<div class="definition"><strong>Emergency Fund:</strong> A reserved portion of savings for unexpected short-term expenses, designed to maintain adequate liquidity.</div>

<div class="definition"><strong>Risk Tolerance:</strong> An individual's capacity to accept potential losses on investments, both in terms of investment return and principal.</div>

<div class="definition"><strong>SMART Goals:</strong> Financial goals that are Specific, Measurable, Actionable, Realistic, and Timely — the standard framework for goal-setting in personal financial planning.</div>

<div class="definition"><strong>Pay Yourself First:</strong> A savings discipline whereby a fixed portion of income is directed to savings or investment before any expenses are paid, ensuring consistent wealth accumulation.</div>
