...
There is no required textbook; all readings are available electronically through course reserves on LEARN. Assessments include two case studies (35% each), and a two-part reflection paper (5% for Part 1, 25% for Part 2). Jacobs approaches all course content from a **sex-positive** standpoint — a framework that affirms each person's right to define and experience their sexuality across the lifespan, that avoids moralistic value judgments, and that celebrates the diversity of bodies, identities, and consensual practices.

---

# Week 1: Introduction to Course, Language, and the Aging Landscape
...
# Week 2: Sexuality and Relationships in Mid and Later Life
...
# Week 3: Sex in Mid and Later Life — Activity, Health, and Risk
...
## Week 4: Relationships in Mid and Later Life
...
## Week 5: Aging with Pride — 2SLGBTQI+ Experiences
...
## Week 6: Dementia and Sexual Consent
...
## Week 8: Healthcare and Long-Term Care
...
## Week 10: End-of-Life Planning and Alternative Living
...
## Week 12: Ageism and Aging Anxiety
...
The two-part reflection paper is the most personally oriented assessment in the course. **Part 1** (due Week 2, worth 5%) is a brief, point-form, 1–2 page summary in which students articulate their current values, beliefs, biases, and assumptions about the sexuality and relationships of people in mid and later life, and reflect on how they came to hold those views. It is due early so that responses are not yet shaped by course content.

**Part 2** (due Week 13, worth 25%) is a 4–5 page double-spaced reflective essay in which students return to their Part 1 responses and assess whether and how their values, beliefs, biases, and assumptions have changed over the course of the semester. If changes have occurred, students explain what changed, why, and how those changes will influence their lives and practices moving forward. The paper must incorporate a minimum of three assigned course readings and use APA format.

## Case Studies

Both case studies are worth 35% each and draw on specific current events to anchor broader ethical and social analysis. Students write 4–5 page discussions from multiple perspectives, incorporating a minimum of two assigned course readings and one additional source.

**Case Study One** (due Week 6) is based on the *Globe and Mail* article on dementia, intimacy, and sexual consent. Questions address consent capacity, the role of institutions and families, legal frameworks, and the rights of people living with dementia to sexual expression and intimate relationships.

**Case Study Two** (due Week 7) is based on the CBC News article about Joe Overtveld, a multimillionaire whose family disputed his marriage and relationships in later life. Questions address exploitation, autonomy, ageism, loneliness, legal thresholds, and the social expectations placed on older adults regarding where and with whom they live.

All written work uses APA formatting, requires a title page, introduction, body, conclusion, and references section, and is assessed on argument quality, multi-perspectival engagement, use of course readings, writing quality, and adherence to formatting requirements.
