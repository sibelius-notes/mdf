...
(1) The vector self-ligates with no insert: ampicillin resistant, tetracycline resistant — because the *tet* gene is reconstituted. Unwanted.
(2) The linearized vector fails to recircularize: no plasmid, no transformant — the colony is lost.
(3) A Bacillus DNA fragment (not the amylase gene) inserts into the vector: ampicillin resistant, tetracycline sensitive — because any insert disrupts *tet*. Partial interest.
