...
**Online resources** — University of Waterloo LEARN course outline for ANTH 465/LS 425/SOC 425 (Fall 2023). | Various open-access anthropological databases and lecture notes on border studies, political anthropology, and the ethnography of migration.
...
<strong>Border as productive force</strong>: In anthropological theory, borders are not merely lines of separation but active agents that produce identities, categories, and forms of social organization. Pelkmans' ethnography illustrates how the Georgian-Turkish border created new ethnic and religious identities that persisted long after the border itself became permeable.
</div>
...
<div class="remark">
Fassin's key insight is that the policing of territorial borders and the production of social boundaries are not separate processes but two dimensions of the same governmental practice. When police stop someone for an identity check, they are simultaneously enforcing a territorial border (by checking authorization to be in a given territory) and producing a social boundary (by marking the stopped person as someone who does not self-evidently belong). The border, in this sense, is everywhere — not just at the frontier but wherever the state exercises its power to sort, classify, and differentiate.
</div>
...
<div class="definition">
<strong>Refusal</strong>: In Simpson's framework, refusal is both a political practice and an analytical concept. As a political practice, it describes the ways Indigenous peoples decline to accept the legitimacy of settler state authority over their lives and territories. As an analytical concept, it challenges the assumptions of liberal political theory, which tends to frame Indigenous claims in terms of recognition, accommodation, or inclusion within the settler state. Refusal insists on an alternative framework: one in which Indigenous sovereignty is not granted by the settler state but exists prior to and independent of it.
</div>
...
<div class="definition">
<strong>Border as method</strong>: Mezzadra and Neilson's approach treats the border not as a thing to be studied but as a vantage point from which to observe the workings of contemporary capitalism, sovereignty, and subjectivity. Borders, in their analysis, are not opposed to globalization but are constitutive of it: they do not simply block flows of labor and capital but channel, differentiate, and hierarchize them.
</div>
...
<div class="remark">
Andersson identifies what he calls the <strong>temporal economics of illegality</strong>: the ways in which border regimes manipulate time as a mechanism of control. Migrants are made to wait — in transit camps, in detention centers, in bureaucratic queues — and this waiting is not incidental but constitutive of their experience of borders. Time becomes a resource that is distributed unequally: those with legal status can move quickly and efficiently, while those without it are trapped in protracted limbo.
</div>
...
<div class="definition">
<strong>Affective geography</strong>: Navaro-Yashin's concept refers to the emotional and psychological landscapes produced by political arrangements. In the case of northern Cyprus, the unrecognized border that separates the north from the south produces distinctive feelings of melancholy, absurdity, and entrapment that shape everyday life. The border is not just a political fact but an affective reality — it is felt, not just known.
</div>
...
<div class="remark">
Ticktin's critique raises uncomfortable questions about the politics of compassion. If humanitarian interventions at borders serve to legitimate the very border regimes that produce migrant suffering, then what would it mean to think <strong>beyond</strong> humanitarian borders? Ticktin suggests that this requires a fundamental rethinking of the relationship between borders, sovereignty, and human rights — one that does not take the nation-state system as given but asks how it might be otherwise.
</div>
...
<div class="definition">
<strong>Framing borders</strong>: Kalman's analytical concept describes the interpretive work through which border-affected communities make sense of borders and their implications. Framing involves both cognitive and practical dimensions: it shapes how people understand the border (as legitimate or illegitimate, permanent or temporary, barrier or resource) and how they act in relation to it (compliance, resistance, pragmatic navigation).
</div>
...
<div class="definition">
<strong>Illegality</strong>: In Khosravi's framework, illegality is not an objective status but a socially and politically produced category. It is created through the interaction of migration aspirations with legal regimes that restrict mobility. The production of illegality serves important functions for states (enabling the exploitation of undocumented labor, demonstrating sovereign authority) and for capital (creating a pool of vulnerable, low-cost workers).
</div>
...
<div class="remark">
The concept of the <strong>border within</strong> illustrates one of the most important insights of the anthropology of borders: that borders are not only physical structures but also psychological and social realities. The border within is a product of structural violence — the systematic denial of rights, recognition, and security that characterizes the lives of undocumented migrants. But it is also, as Khosravi shows, a site of resistance and resilience. Migrants find ways to live with and against the border within, creating communities, sustaining hope, and asserting their humanity in the face of dehumanizing conditions.
</div>
...
<div class="definition">
<strong>Prevention Through Deterrence (PTD)</strong>: The U.S. Border Patrol strategy, implemented beginning in 1994, that deliberately concentrates enforcement resources at urban crossing points to redirect unauthorized border crossers into remote and dangerous terrain. The policy assumes that the physical dangers of crossing — extreme heat, dehydration, injury, death — will discourage future migration attempts. De León argues that PTD constitutes a form of structural violence, producing thousands of deaths in the desert while allowing the state to disclaim direct responsibility.
</div>
...
<div class="definition">
<strong>Necroviolence</strong>: De León's concept refers to violence performed against or through dead bodies. In the context of the U.S.-Mexico border, necroviolence operates through the desert's destruction of migrant remains. The state does not directly kill migrants (in most cases), but it creates conditions in which death is predictable and the destruction of bodies is inevitable. This allows the state to maintain what De León calls <strong>plausible deniability</strong>: the deaths are attributed to the desert, to the migrants' own choices, or to the smugglers who guide them, rather than to the enforcement policies that funneled them into danger.
</div>
...
<div class="remark">
De León's ethnography of the Border Patrol station and the migrant shelter reveals the intimate, bodily dimensions of border enforcement. Migrants describe being cold, hungry, and exhausted in the processing station; they describe the relief of arriving at the shelter. These bodily experiences are not incidental to the border regime but central to how it operates. The physical discomfort of detention is, in De León's analysis, a deliberate part of the deterrence strategy: it is meant to make the crossing so miserable that migrants will not attempt it again. The fact that many do attempt it again testifies to the desperation that drives migration and the limits of deterrence as a policy strategy.
</div>
...
<div class="remark">
De León's decision to narrate Maricela's story at length is an ethical and political choice. By giving Maricela a name, a history, and a set of relationships, De León resists the dehumanization that the border regime produces. The anonymous migrant body in the desert is transformed into a person with a life, a family, and a story. This insistence on the particularity of individual lives is a form of ethnographic testimony — a refusal to let structural violence reduce people to statistics.
</div>
...
<div class="definition">
<strong>Political imagination</strong>: Ticktin's concept refers to the collective capacity to envision and enact political arrangements. Borders are products of political imagination because they embody specific assumptions about sovereignty, territory, identity, and belonging. But political imagination is not static: it can be reimagined, and borders can be remade. Ticktin argues that the current moment calls for a reimagining of borders — a political imagination that takes seriously the claims of migrants, refugees, and stateless people.
</div>
...
<div class="definition">
<strong>Border thinking</strong>: A decolonial epistemological framework proposed by Mignolo and Tlostanova that privileges the perspectives of those who inhabit the margins of the modern/colonial world system. Border thinking challenges the universalist pretensions of Western social theory by showing that concepts like sovereignty, citizenship, and territory are not neutral descriptions of political reality but products of a particular historical formation — European colonial modernity — that has systematically excluded and subordinated non-European peoples and knowledge systems.
</div>
