...
<div class="example">
<strong>Example: Comparing Extension Voicings on G7.</strong> Here are four common realizations of the dominant seventh chord on G at the piano:
<br>
G7 (basic shell): G - B - F (root, M3, m7; the fifth D is omitted)
<br>
G9: G - B - F - A (adding the ninth)
<br>
G13: G - B - F - E (adding the thirteenth, omitting fifth and ninth)
<br>
G9(13): G - B - F - A - E (ninth and thirteenth; the fifth D continues to be omitted as acoustically expendable)
<br>
...
<div class="remark">
<strong>Remark (Spelling Conventions for Alterations).</strong> The notations ♭5 and ♯11 refer to the same pitch class (e.g., D♭ on a G dominant chord) but imply different analytical frames. Writing ♭5 treats the alteration as modifying the fifth of the chord (G's fifth is D; lowering it gives D♭). Writing ♯11 treats the same note as an extension (the eleventh above G is C; raising it gives C♯ = D♭). Both notations appear in jazz scores, and a fluent reader recognizes them as equivalent. Similarly, ♯5 and ♭13 name the same pitch (E♭ on a G dominant chord): ♯5 modifies the fifth (D♯ = E♭), ♭13 is a lowered extension. In general, when a chord contains both a fifth and an altered fifth simultaneously (rare but possible in written arrangements), the distinction matters; otherwise the two spellings are freely interchangeable.
</div>
...
<div class="example">
<strong>Example: Rootless Voicings through a ii-V-I in C.</strong>
<br>
Dm9 (rootless): F - A - C - E (third, fifth, seventh, ninth; root D in bass)
<br>
G13 (rootless): F - B - E (seventh, third, thirteenth; root G in bass)
<br>
Cmaj9 (rootless): B - E - G - D (seventh, third, fifth, ninth; root C in bass)
<br>
...
<div class="remark">
<strong>Remark (Diatonic Chord Quality by Scale Degree).</strong> A useful mnemonic for the diatonic seventh chord qualities in any major key: <strong>I and IV are major seventh; II, III, and VI are minor seventh; V is dominant seventh; VII is half-diminished.</strong> This pattern does not change when you transpose to a different major key—only the root names change. A musician who memorizes this pattern and knows all twelve major scales can immediately identify the diatonic seventh chord on any scale degree in any key.
</div>
...
<div class="example">
<strong>Example: Tonic-Group Substitution in C Major.</strong> The standard ending of "Misty" (Erroll Garner, 1954) in E♭ major uses E♭maj7 as its final tonic chord. A reharmonizer might substitute Cm7 (the VIm7, tonic group) for the E♭maj7 in the penultimate measure, creating a more introspective arrival before the final E♭maj7. The listener hears the Cm7 as a temporary detour within the tonic function, not as a departure from it.
</div>
...
<div class="example">
<strong>Example: Minor ii-V-i Voice Leading in G Minor.</strong>
<br>
Am7♭5: A - C - E♭ - G (root, m3, ♭5, m7)
<br>
D7♭9: D - F♯ - A - C - E♭ (root, M3, 5, m7, ♭9)
<br>
Gm6: G - B♭ - D - E (root, m3, 5, M6)
<br>
...
<div class="remark">
<strong>Remark (Dominant Chains and Listener Expectation).</strong> Extended dominant chains exploit the cumulative nature of harmonic expectation. After hearing two or three dominant seventh chords resolve faithfully to their targets, the listener's expectation for the pattern to continue intensifies with each successive dominant. A composer who then breaks the pattern—by deceptive resolution, by a tritone substitute, or by a sudden silence—achieves a heightened effect precisely because the accumulated expectation makes the deviation more surprising. This psychological dimension of harmonic expectation is not purely acoustic; it is learned through exposure, and it explains why jazz harmony is more easily appreciated by listeners who have internalized the style's conventions.
</div>
...
| Dorian | II (D) | D-E-F-G-A-B-C | Minor, but raised 6th gives brightness |
| Phrygian | III (E) | E-F-G-A-B-C-D | Dark, Spanish flavor |
| Lydian | IV (F) | F-G-A-B-C-D-E | Major with raised 4th, dreamy |
| Mixolydian | V (G) | G-A-B-C-D-E-F | Major with lowered 7th, bluesy |
| Aeolian | VI (A) | A-B-C-D-E-F-G | Natural minor |
| Locrian | VII (B) | B-C-D-E-F-G-A | Unstable, diminished quality |
...
<div class="remark">
<strong>Remark (Avoid Notes vs. Passing Tones).</strong> "Avoid note" does not mean "never play this note." It means "do not sustain this note on a strong beat against the underlying chord." The avoid note can appear as a passing tone (briefly touched in an eighth-note run), as an upper neighbor (briefly tonicized above a chord tone), or on a weak beat. The distinction between structural tones (held, accented, melodically prominent) and passing tones (brief, unaccented, connecting) is as important in jazz melody as in classical melody. A note that would be an "avoid note" as a target becomes a colorful passing tone as a transitional element.
</div>
...
<div class="remark">
<strong>Remark.</strong> Sikora's <em>Jazz Harmony</em> presents chord-scale theory with particular care for the question of "avoid notes"—scale degrees that clash badly enough with the underlying chord that they should not be emphasized (landed on downbeats or sustained). For example, the natural eleventh (perfect fourth) is an avoid note on Imaj7 because it creates a minor ninth with the major third. Understanding avoid notes refines the chord-scale system from a blunt tool into a nuanced melodic resource.
</div>
...
|---|---|---|
| 1–4 | I7 (four bars) | Tonic statement |
| 5–6 | IV7 (two bars) | Subdominant departure |
| 7–8 | I7 (two bars) | Tonic return |
| 9 | V7 (one bar) | Dominant tension |
| 10 | IV7 (one bar) | Subdominant passing |
| 11–12 | I7 (turnaround) | Tonic resolution / setup for next chorus |
...
<div class="remark">
<strong>Remark (Blues Tonality).</strong> The use of dominant seventh chords on I, IV, and V simultaneously means that the blues does not "function" in the classical tonal sense—there is no stable tonic triad, and the tritones in each chord do not resolve into one another in any systematic way. Blues harmony is better understood as a cyclic, ritualistic form than as a teleological one. The tension and release in blues comes from the overall form, the melodic contour, and the performance intensity rather than from harmonic resolution in the classical sense.
</div>
...
| 3–4 | Cmaj7 |
| 5–6 | F7 or Fm7 |
| 7–8 | Cmaj7 - Em7♭5 A7♭9 |
| 9 | Dm7 - G7 |
| 10 | Dm7 - G7 or Gm7 - C7 |
| 11 | Cmaj7 - Fm7 - B♭7 (or Em7♭5-A7♭9) |
| 12 | Dm7 - G7 (turnaround) |
...
| 9 | Dm7♭5 - G7♭9 |
| 10 | Cm7 |
| 11–12 | Cm7 - Dm7♭5 G7♭9 (turnaround) |
...
<div class="example">
<strong>Example: Quartal Voicings on D Dorian ("So What" vamp).</strong> Over D Dorian, a pianist might use the following quartal structures:
<br>
Left hand (root position quartal): D - G - C (perfect fourth + perfect fourth = a "stack of fourths")
<br>
Left hand (inverted quartal): A - D - G (same notes, different bass)
<br>
Right hand response: C - F - B - E (a four-note quartal stack a step above the left hand)
<br>
...
<div class="remark">
<strong>Remark (Long-Range Voice Leading).</strong> Sikora's <em>Jazz Harmony</em> argues that voice leading in modal jazz operates at the level of the phrase (8-16 bars) rather than the chord-to-chord level. A modal improvisation that introduces a chromatic pitch (outside the mode) in bar 4 and resolves it in bar 12 is exhibiting voice leading; the resolution is simply delayed by a factor of eight or sixteen compared to bebop. This long-range perspective unifies modal jazz with tonal jazz under a single voice-leading paradigm.
</div>
...
| Chord quality | Primary scale | Key characteristic |
|---|---|---|
| Imaj7 | Ionian (major) | Stable, consonant |
| Imaj7 | Lydian | ♯11 adds floating quality |
| IIm7 | Dorian | ♮6 (raised sixth of minor) |
| IIIm7 | Phrygian | ♭2 (lowered second) |
| IVmaj7 | Lydian | ♯11 avoids avoid note |
| V7 | Mixolydian | ♭7 (lowered seventh) |
| V7 | Altered (super-Locrian) | All four altered tensions |
| V7 | Lydian dominant | ♯11, for tritone subs |
| V7 | H-W diminished | ♭9 and ♯9 simultaneously |
| VIm7 | Aeolian | Natural minor |
| VIIm7♭5 | Locrian | ♭2, ♭5 |
| VIIm7♭5 | Locrian ♮2 | Raised 2nd for minor ii chords |
| Im7 | Dorian | Jazz minor-key vamp |
| Im(maj7) | Melodic minor (jazz minor) | Major 7th in minor context |
| Idim7 | W-H diminished | Symmetric, ♭3, ♭5, ♭♭7 |

<div class="remark">
<strong>Remark (Scale Memorization Strategy).</strong> Rather than memorizing chord-scale assignments as isolated facts, practice them by playing each scale over its corresponding chord at the piano, listening carefully to the characteristic sound of each scale degree against the chord. The ♯11 of Lydian against a maj7 chord, the ♭9 of the altered scale against a dominant seventh, the ♮6 of Dorian against a minor seventh—these sounds are the vocabulary of jazz harmony, and they must be known by ear as surely as words are known by sound in a language. Theory without sound is notation; sound without theory is imitation. The goal of jazz theory education is to unite them.
</div>
