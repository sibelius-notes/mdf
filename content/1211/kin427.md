...
KIN 427 covers the biomechanics, anatomy, pathology, and clinical management of low back disorders (LBD), a leading cause of disability worldwide. The course is taught by Dr. Jack Callahan at the University of Waterloo (Winter 2021) and draws from three core reference texts: *Back Mechanic* (McGill), *The Biomechanics of Back Pain* (Adams et al.), and *Biomechanics: Principles and Applications* (Zernicke and Whiting).

The course is organized around eight units spanning epidemiology, pain science, lumbar anatomy, tissue and structural mechanics, movement control, electromyography, biomechanical modeling, and clinical classification. A unifying **demand-capacity framework** threads through every unit: injury and dysfunction occur when mechanical or physiological demand exceeds the tissue's capacity to sustain load. Evaluation format consists of two term tests, eight unit quizzes, and weekly reading of primary literature.

Bloom's taxonomy guides expectation levels. Lower-order objectives require recall of anatomical names and mechanical values. Higher-order objectives require synthesis: given a posture, loading condition, or patient presentation, students should be able to predict tissue-level consequences, propose appropriate interventions, and critique published evidence.
