...
<div class="definition"><strong>Definition</strong> (Complete Projective Measurement). Let \(\mathcal{B} = \{|u_i\rangle : i \in [d]\}\) be an orthonormal basis of \(\mathbb{C}^d\). A complete projective measurement of a state \(|\psi\rangle\) in basis \(\mathcal{B}\) yields outcome \(i\) with probability
...
<div class="theorem"><strong>Theorem</strong> (Nayak 1999). Let \(X \in \{0,1\}^m\) be uniformly random. Suppose we encode \(x\) by an \(n\)-qubit state \(|\psi_x\rangle\). Let \(Y\) be the outcome of any measurement of \(|\psi_X\rangle\). Then
...
<div class="theorem"><strong>Proposition</strong> (Hiding and Binding). The quantum protocol satisfies:
<ul>
...
<div class="definition"><strong>Definition</strong> (Pure State of \(n\) Qubits). A general pure quantum state of \(n\) qubits is a unit vector
\[|\psi\rangle = \sum_{x \in \{0,1\}^n} \alpha_x |x\rangle, \qquad \sum_x |\alpha_x|^2 = 1.\]</div>

<div class="definition"><strong>Definition</strong> (Tensor Product). For vectors \(|u\rangle \in \mathbb{C}^{d_1}\) and \(|v\rangle \in \mathbb{C}^{d_2}\), the tensor product \(|u\rangle \otimes |v\rangle \in \mathbb{C}^{d_1 d_2}\) is defined by
...
<div class="theorem"><strong>Theorem</strong> (Bennett–Wiesner 1992). Suppose Alice and Bob share an EPR pair \(|\phi_{00}\rangle = \frac{1}{\sqrt{2}}(|00\rangle + |11\rangle)\). To send two bits \(a, b \in \{0,1\}\):
<ol>
...
<div class="theorem"><strong>Theorem</strong> (Teleportation, Bennett et al. 1993). Suppose Alice has qubit \(M\) in unknown state \(|\psi\rangle = \alpha|0\rangle + \beta|1\rangle\) and Alice and Bob share \(|\phi_{00}\rangle\). Alice can help Bob reconstruct \(|\psi\rangle\) by sending only 2 classical bits:
<ol>
...
<div class="proof"><strong>Proof.</strong> The initial state of \(ME_1 E_2\) is \(|\psi\rangle \otimes |\phi_{00}\rangle\). Expanding:
...
<div class="definition"><strong>Definition</strong> (Quantum Fourier Transform). The QFT over \(\mathbb{Z}_{2^m}\) is the unitary operator
...
<div class="theorem"><strong>Takeaways from Quantum Error Correction.</strong>
<ol>
