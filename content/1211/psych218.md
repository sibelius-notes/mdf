...
<strong>Death anxiety</strong>: A multidimensional construct encompassing fear, dread, and apprehension related to one's own death, the dying process, or the death of significant others. Death anxiety is central to multiple theoretical traditions in the psychology of death.
</div>

<div class="definition">
<strong>Thanatology</strong>: The scientific and scholarly study of death, dying, and bereavement. Modern thanatology is inherently interdisciplinary, drawing on psychology, sociology, medicine, philosophy, theology, and the humanities.
</div>

<div class="definition">
<strong>Mortality salience</strong>: The state of heightened awareness of one's own mortality, often experimentally induced in research. Mortality salience has been shown to produce a wide range of cognitive, emotional, and behavioral effects.
</div>
...
<div class="definition">
<strong>Biological death</strong>: The irreversible cessation of all biological functions that sustain a living organism. At the cellular level, death involves the breakdown of homeostatic mechanisms, the failure of metabolic processes, and eventual decomposition.
</div>
...
<div class="remark">
<strong>Anthropomorphism versus anthropodenial</strong>: Masson and McCarthy argued that the scientific community had erred too far in the direction of denying animal emotions (<strong>anthropodenial</strong>), just as uncritical attribution of human-like emotions to animals (<strong>anthropomorphism</strong>) is problematic. The challenge is to develop rigorous methods for studying animal emotional states while remaining open to the possibility that other species experience something analogous to grief.
</div>
...
1. **Evolutionary continuity**: If other species experience something like grief, then human grief may have deep evolutionary roots rather than being a purely cultural construction.
2. **Attachment as foundation**: The intensity of grief responses across species appears to correlate with the strength of social bonds, suggesting that attachment is a fundamental precondition for grief.
3. **Death awareness as a spectrum**: The question of whether animals "know" they will die remains open, but it is clear that the behavioral and possibly emotional foundations of death-related responding are not unique to humans.
...
<div class="definition">
<strong>Terror Management Theory (TMT)</strong>: A social psychological theory, derived from the work of Ernest Becker, which proposes that awareness of the inevitability of death creates the potential for paralyzing terror. Humans manage this terror through two primary psychological structures: <strong>cultural worldviews</strong> (shared belief systems that provide meaning, order, and the promise of literal or symbolic immortality) and <strong>self-esteem</strong> (the sense that one is a valuable member of a meaningful universe).
</div>
...
2. **The anxiety-buffer hypothesis**: If self-esteem and worldview validation serve as buffers against death anxiety, then bolstering these should reduce the accessibility of death-related thoughts and the anxiety associated with death reminders.

3. **The death-thought accessibility hypothesis**: Threats to self-esteem or cultural worldview should increase the accessibility of death-related thoughts, because the anxiety buffer has been weakened.
...
<div class="remark">
Key contributions of Juhl and Routledge (2016):
<ul>
<li>Provided direct evidence that death awareness causes anxiety (not just downstream defensive behaviors)</li>
<li>Showed that the effect is moderated by the presence or absence of psychological buffers</li>
<li>Strengthened the theoretical coherence of TMT by filling a critical empirical gap</li>
</ul>
</div>
...
1. **Tame death** (early medieval period): Death was familiar, expected, and accepted as part of the natural order. The dying person typically knew death was approaching, made preparations, and died surrounded by community members, including children.

2. **Death of the self** (12th--15th centuries): Increasing emphasis on individual judgment and the fate of the soul after death. The *ars moriendi* ("art of dying") literature provided guidance for achieving a good death.

3. **Remote and imminent death** (18th century): Death became more emotionally charged, with romantic idealization of the death of the other (especially the beloved). Mourning became more elaborate.

4. **Forbidden death** (20th century): Death was increasingly sequestered in hospitals, sanitized by professionals, and excluded from everyday discourse. Ariès argued that modern Western societies had developed a "death taboo" comparable in strength to the Victorian sex taboo.

5. **Contemporary period**: Some scholars argue that the late 20th and early 21st centuries have seen a partial return of death to public discourse, driven by the hospice movement, death-positive activism, and media saturation with death imagery.
...
<div class="definition">
<strong>Dual Process Model (DPM)</strong>: A model of bereavement coping that identifies two types of stressors and two corresponding orientations:
<ul>
<li><strong>Loss-oriented coping</strong>: Focused on processing the loss itself -- grief work, emotional processing, dwelling on the deceased, and working through the meaning of the loss.</li>
<li><strong>Restoration-oriented coping</strong>: Focused on the secondary consequences of loss -- attending to life changes, developing new identities, mastering tasks previously handled by the deceased, and building new relationships.</li>
</ul>
The model's central concept is <strong>oscillation</strong>: healthy coping involves moving back and forth between loss-oriented and restoration-oriented processes, rather than being stuck in either one.
</div>
...
<div class="remark">
McKinley et al. (2020) challenged the assumption that grief can be understood apart from its historical and structural context. Their work demonstrates that the psychology of death and dying must attend to how power, oppression, and inequality shape who dies, when, and how the survivors cope.
</div>
...
1. **Advances in medical technology**: The development of antibiotics, surgery, mechanical ventilation, and other life-sustaining technologies created new possibilities for prolonging life -- and new questions about when to stop.
2. **Hospitalization of death**: By the mid-20th century, the majority of deaths in developed nations occurred in hospitals. The dying person was removed from the familiar home environment and placed in an institutional setting oriented toward cure rather than comfort.
3. **Professionalization of death care**: The care of the dead body shifted from families and community members to funeral directors and embalmers, further distancing ordinary people from the reality of death.

### The Medicalization Critique

<div class="definition">
<strong>Medicalization of death</strong>: The process by which death and dying have come to be defined primarily as medical events, subject to medical authority and managed through medical institutions and technologies. Critics argue that medicalization has dehumanized dying by prioritizing biological survival over quality of life, meaning, and personal autonomy.
</div>
...
<div class="definition">
<strong>Palliative care</strong>: An approach to care for patients with serious illness that focuses on relief from symptoms, pain, and stress, with the goal of improving quality of life for both patients and families. Palliative care can be provided alongside curative treatment and is not limited to end-of-life situations.
</div>

#### Hospice Care

<div class="definition">
<strong>Hospice care</strong>: A philosophy and model of care for patients with a terminal prognosis (typically six months or less), emphasizing comfort, dignity, and quality of life rather than cure. Hospice care is provided in the home, in dedicated hospice facilities, or within hospitals and nursing homes.
</div>
...
<div class="definition">
<strong>Euthanasia</strong>: The deliberate ending of a person's life to relieve suffering. <strong>Voluntary euthanasia</strong> occurs at the explicit request of the patient. <strong>Non-voluntary euthanasia</strong> occurs when the patient cannot consent (e.g., is in a persistent vegetative state). <strong>Involuntary euthanasia</strong> occurs against the patient's will and is universally condemned.
</div>

<div class="definition">
<strong>Physician-assisted dying (PAD)</strong>: A practice in which a physician provides the means (typically a prescription for lethal medication) for a patient to end their own life, but the patient self-administers the medication. Distinct from euthanasia, in which the physician administers the lethal agent directly.
</div>
...
<div class="definition">
<strong>Cardiopulmonary death</strong>: The traditional legal definition of death based on the irreversible cessation of circulatory and respiratory functions. This definition served adequately for most of human history but became problematic with the advent of mechanical ventilation and other life-support technologies.
</div>

<div class="definition">
<strong>Brain death</strong>: The irreversible cessation of all functions of the entire brain, including the brainstem. The concept of brain death was introduced in 1968 by the Harvard Ad Hoc Committee and has been adopted as the legal standard for death in most developed nations, though specific criteria vary by jurisdiction.
</div>
...
<div class="definition">
<strong>Advance directive</strong>: A legal document in which a person specifies their wishes regarding medical treatment in the event that they become unable to communicate those wishes. Common types include living wills and durable powers of attorney for health care.
</div>

<div class="definition">
<strong>Living will</strong>: An advance directive that specifies the types of medical treatment a person does or does not want to receive under certain conditions (e.g., persistent vegetative state, terminal illness).
</div>

<div class="definition">
<strong>Durable power of attorney for health care</strong>: An advance directive that designates a trusted person (a <strong>proxy</strong> or <strong>surrogate</strong>) to make medical decisions on behalf of the patient if the patient becomes unable to do so.
</div>
...
1. **Meaning-making**: Religious frameworks provide explanations for why death occurs, what it means, and what follows -- reducing the existential uncertainty that death creates.
2. **Afterlife as anxiety buffer**: Belief in literal immortality directly addresses the fundamental terror identified by TMT. Research has shown that religious afterlife beliefs decrease behavioral avoidance of mortality symbols and reduce death anxiety in many (though not all) contexts.
3. **Religious coping behaviors**: Prayer, scripture reading, ritual participation, and religious community involvement provide both cognitive and social resources for managing death-related distress.
4. **Social support**: Religious communities often provide structured support for the dying and the bereaved, through visitation, meal provision, funeral rites, and ongoing memorial practices.
...
1. **Relational comfort**: Religion offers a sense of being in relationship with God, a higher power, or a spiritual community, reducing the sense of isolation that can accompany dying.
2. **Hope of life after death**: The belief that death is not the end provides reassurance and reduces fear. For many participants, the afterlife was imagined as a reunion with deceased loved ones.
3. **Identification**: Participants found comfort in identifying with religious figures who had suffered and died -- most prominently, for Christian participants, the suffering and resurrection of Jesus.
4. **Cosmic order**: The belief that the universe is governed by a benevolent and meaningful order helped participants make sense of their suffering and accept their mortality.

<div class="remark">
Pevey et al.'s findings align with TMT's prediction that cultural worldviews (including religious worldviews) serve as anxiety buffers. However, their qualitative approach revealed nuances that quantitative research alone might miss -- particularly the deeply relational quality of religious comfort and the diversity of specific beliefs even within a single tradition.
</div>
...
<div class="remark">
Khayambashi's (2019) research highlights the tension between the historical sequestration of death (its removal from everyday visibility) and the hypervisibility of death in digital media. The internet death video community represents an extreme case of re-exposure to death imagery, raising questions about voyeurism, desensitization, and the psychological effects of witnessing real death.
</div>
...
<div class="definition">
<strong>Collective memory</strong>: The shared representations of the past that a group constructs and maintains. Collective memory is not a simple reflection of historical events but is actively shaped by present political needs, power relations, and cultural values.
</div>
...
<div class="remark">
Kelmendi et al. (2020) demonstrated that grief in the context of political violence cannot be understood apart from the broader political and historical context. The meaning of a death caused by ethnic violence, state repression, or war carries political significance that shapes the grief process in ways that individual-level models of bereavement may not fully capture.
</div>
...
<div class="definition">
<strong>Bereavement</strong>: The objective situation of having lost a significant person through death. Bereavement is a state, not a process.
</div>

<div class="definition">
<strong>Grief</strong>: The emotional, cognitive, behavioral, and physiological response to bereavement. Grief encompasses a wide range of experiences including sadness, anger, guilt, yearning, confusion, and physical symptoms.
</div>

<div class="definition">
<strong>Mourning</strong>: The social expression of grief, shaped by cultural norms, rituals, and expectations. Mourning practices provide structure for the grief process and facilitate social support.
</div>
...
1. **Accept the reality of the loss**: Overcoming denial and acknowledging that the person is dead and will not return.
2. **Process the pain of grief**: Allowing oneself to experience the full range of grief emotions rather than suppressing or avoiding them.
3. **Adjust to a world without the deceased**: Adapting to the practical, social, and existential changes caused by the loss.
4. **Find an enduring connection with the deceased while embarking on a new life**: Maintaining an appropriate bond with the deceased while reinvesting in living.
...
1. **Loss affects the entire family system**: When a family member dies, the loss disrupts the family's established patterns of interaction, roles, and relationships. Every member of the family is affected, though in different ways.

2. **Timing in the family life cycle matters**: The impact of a death depends on when it occurs in the family's developmental trajectory. The death of a young child, for example, creates different systemic disruptions than the death of an elderly grandparent. Particularly disruptive are:
...
5. **Multigenerational patterns**: Families develop characteristic ways of dealing with loss that are transmitted across generations. These patterns include:
...
<div class="remark">
Walsh and McGoldrick (1991) fundamentally shifted bereavement theory from an individual to a systemic perspective. Their framework illuminated how family dynamics -- including pre-existing conflicts, coalitions, secrets, and communication styles -- shape the bereavement process and how the death of a member can catalyze either growth or dysfunction within the family system.
</div>
...
<div class="definition">
<strong>Complicated grief</strong> (also called <strong>prolonged grief disorder</strong> or <strong>persistent complex bereavement disorder</strong>): A condition characterized by persistent, intense grief that significantly impairs functioning for an extended period (typically more than 12 months in adults). Symptoms include intense yearning for the deceased, difficulty accepting the death, emotional numbness, difficulty engaging in ongoing life, and a pervasive sense that life is meaningless without the deceased.
</div>
...
<div class="definition">
<strong>Disenfranchised grief</strong>: Grief that is not socially acknowledged, publicly mourned, or socially supported. Coined by Kenneth Doka (1989), the concept highlights losses that society does not recognize as legitimate bases for grief, including the death of an ex-spouse, a pet, a same-sex partner (in unsupportive contexts), or a stillborn child.
</div>
...
1. **Irreversibility**: The understanding that death is permanent and cannot be undone. Young children (typically under age 5) may believe that death is temporary or reversible, like sleep or a journey.

2. **Universality**: The understanding that all living things die. Young children may believe that death happens only to certain people (old people, bad people, or strangers) and that they and their loved ones are exempt.

3. **Nonfunctionality**: The understanding that all life-defining functions (breathing, thinking, feeling, moving) cease at death. Young children may attribute continued experience to the dead (e.g., believing that a dead person can still feel cold or hungry).

4. **Causality**: The understanding of what causes death (biological processes, disease, injury). Young children may have magical or animistic explanations for death.
...
<div class="remark">
Manoogian et al. (2017) highlighted that grandparent death is often the first significant bereavement experience for emerging adults, making it a developmentally pivotal event. Their study underscored how family systems, attachment, and developmental timing interact to shape the grief experience.
</div>
...
1. **Protection**: Both adult children and dying parents engage in protective behavior, shielding each other from the full emotional weight of the situation. Adult children may avoid discussing death to protect the parent; parents may minimize their symptoms to protect the child.
2. **Meeting needs**: Communication is shaped by the practical and emotional needs of both parties, which may be in tension.
3. **Guilt and regret**: Adult children frequently report guilt about not communicating enough, not saying the right things, or not being present enough during the dying process.
4. **Control**: Issues of control permeate end-of-life communication -- control over information, decisions, emotional expression, and the dying process itself.
5. **Family dynamics**: Pre-existing family communication patterns, sibling relationships, and family roles all shape end-of-life communication.
6. **Communication type**: The mode and style of communication (direct versus indirect, verbal versus nonverbal, frequent versus sporadic) affect the quality of the end-of-life relationship.
...
<div class="definition">
<strong>Templer Death Anxiety Scale (DAS)</strong>: A 15-item true/false scale developed by Donald Templer (1970), one of the earliest and most widely used measures of death anxiety. Items address fear of dying, concern about pain, and uncertainty about an afterlife.
</div>

<div class="definition">
<strong>Collett-Lester Fear of Death Scale</strong>: A multidimensional measure that distinguishes between fear of death and fear of dying, for both self and others, yielding four subscales.
</div>

<div class="definition">
<strong>Death Attitude Profile-Revised (DAP-R)</strong>: Developed by Wong, Reker, and Gesser (1994), this scale measures not only death fear/avoidance but also death acceptance (including neutral acceptance, approach acceptance, and escape acceptance).
</div>
...
<div class="remark">
Together, the research by Mueller et al. (2017) and Kang (2019) underscored a central theme of the personality-level analysis: while death is universal, the experience of death anxiety is profoundly individual. Personality traits, attachment patterns, meaning systems, and self-concept all shape whether mortality awareness is experienced as paralyzing terror, motivating urgency, or serene acceptance.
</div>
...
1. **Neutral acceptance**: Viewing death as a natural, inevitable part of life -- neither welcomed nor feared.
2. **Approach acceptance**: Looking forward to death because of beliefs about a positive afterlife.
3. **Escape acceptance**: Viewing death as a welcome escape from a life of pain and suffering.
