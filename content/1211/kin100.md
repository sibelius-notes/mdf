...
KIN 100: Introduction to Human Anatomy is a first-year survey course at the University of Waterloo, taught in Winter 2021 by Jeremy Roth. The course provides a systematic introduction to the anatomical structures of the musculoskeletal system, peripheral nervous system, and basic neuroanatomy, with emphasis on the limbs and trunk. Assessment consists of a midterm examination, a final examination, and a practical oral exam in which students identify anatomical structures on prosected cadavers. The course draws primarily on *Clinically Oriented Anatomy* (8th edition, COA) and the Complete Anatomy 3D application.

The central conceptual framework of the course is this: to understand movement, you must understand where muscles attach, which nerve supplies them, and how that nerve arose. Every muscle table in these notes follows the format of origin, insertion, action, and innervation. Mnemonics are highlighted where they aid retention.
