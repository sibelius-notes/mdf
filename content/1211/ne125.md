...
NE 125 is a first-year nanotechnology engineering course covering the fundamental science of materials — what they are made of, how they are structured at every scale, and how that structure determines the properties we observe in everyday objects and engineered devices. The course follows the classical materials science paradigm and proceeds from atomic-level phenomena upward through crystals, defects, and diffusion to macroscopic mechanical properties. It is designed to give nanotechnology engineering students the foundational vocabulary and analytical tools they will use throughout their degree.

**Evaluation:** 5 assignments × 5% + 5 quizzes × 5% = 50%; final exam = 50%. Assignments and quizzes alternate on Wednesdays. Quizzes are 90 minutes within a 24-hour access window. The recommended (optional) textbook is Callister, *Materials Science and Engineering: An Introduction* (Wiley).
